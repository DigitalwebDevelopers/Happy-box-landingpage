    ...
    e.extend(e.fn, {
        ...
        rules: function(t, i) {
            ...
            if (null != d && (!d.form && c && (d.form = this.closest("form")[0], d.name = this.attr("name")), null != d.form)) {
                if (t) switch (n = (s = e.data(d.form, "validator").settings).rules, a = e.validator.staticRules(d), t) {
                    case "add":
                ...
                return (o = e.validator.normalizeRules(e.extend({}, e.validator.classRules(d), e.validator.attributeRules(d), e.validator.dataRules(d), e.validator.staticRules(d)), d)).required && (r = o.required, delete o.required, o = e.extend({
                    required: r
                }, o)), o.remote && (r = o.remote, delete o.remote, o = e.extend(o, {
                    remote: r
                })), o
            }
        }
        ...
        prototype: {
            init: function() {
                ...
                function n(t) {
                    var s = void 0 !== e(this).attr("contenteditable") && "false" !== e(this).attr("contenteditable");
                    if (!this.form && s && (this.form = e(this).closest("form")[0], this.name = e(this).attr("name")), i === this.form) {
                        var n = e.data(this.form, "validator"),
                            a = "on" + t.type.replace(/^validate/, ""),
                            o = n.settings;
                        o[a] && !e(this).is(o.ignore) && o[a].call(n, this, t)
                    }
                }
                ...
                }), t = this.settings.rules, e.each(t, function(i, s) {
            ...
            elementValue: function(t) {
                ...
                return "radio" === a || "checkbox" === a ? this.findByName(t.name).filter(":checked").val() : "number" === a && void 0 !== t.validity ? t.validity.badInput ? "NaN" : n.val() : (i = o ? n.text() : n.val(), "file" === a ? "C:\\fakepath\\" === i.substr(0, 12) ? i.substr(12) : (s = i.lastIndexOf("/")) >= 0 ? i.substr(s + 1) : (s = i.lastIndexOf("\\")) >= 0 ? i.substr(s + 1) : i : "string" == typeof i ? i.replace(/\r/g, "") : i)
            },
            check: function(t) {
                t = this.validationTargetFor(this.clean(t));
                var i, s, n, a, o = e(t).rules(),
                    r = e.map(o, function(e, t) {
                        return t
                    }).length,
                    l = !1,
                    d = this.elementValue(t);
                for (s in "function" == typeof o.normalizer ? a = o.normalizer : "function" == typeof this.settings.normalizer && (a = this.settings.normalizer), a && (d = a.call(t, d), delete o.normalizer), o) {
                    n = {
                        method: s,
                        parameters: o[s]
                    };
            ...
            showLabel: function(t, i) {
                var s, n, a, o, r = this.errorsFor(t),
                    l = this.idOrName(t),
        ...
        attributeRules: function(t) {
            ...
            for (i in e.validator.methods) "required" === i ? ("" === (s = t.getAttribute(i)) && (s = !0), s = !!s) : s = a.attr(i), this.normalizeAttributeRule(n, o, i, s);
        ...
        dataRules: function(t) {
            var i, s, n = {},
                a = e(t),
                o = t.getAttribute("type");
            for (i in e.validator.methods) "" === (s = a.data("rule" + i.charAt(0).toUpperCase() + i.substring(1).toLowerCase())) && (s = !0), this.normalizeAttributeRule(n, o, i, s);
            return n
        },
        ...
        methods: {
            ...
            remote: function(t, i, s, n) {
                ...
                return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), l.originalMessage = l.originalMessage || this.settings.messages[i.name][n], this.settings.messages[i.name][n] = l.message, s = "string" == typeof s && {
                    url: s
                } || s, r = e.param(e.extend({
                    data: t
                }, s.data)), l.old === r ? l.valid : (l.old = r, a = this, this.startRequest(i), (o = {})[i.name] = t, e.ajax(e.extend(!0, {
                    mode: "abort",
...
function(e, t) {
    ...
    var v, g, b, y = {
        ...
        on: function() {
            ...
            function r(e) {
                ...
                if (t) {
                    ...
                    if (i.indexOf(e) < 0 && i.unshift(e), m(t).is(n)) a.apply(t, i);
                    else
                        for (var s = m(t).parents(), o = 0; o < s.length; o += 1) m(s[o]).is(n) && a.apply(s[o], i)
                }
            }
                ...
                for (var d = r[l], c = 0; c < this.length; c += 1) {
                    ...
                    if (!n && p.dom7Listeners ? u = p.dom7Listeners[d] : n && p.dom7LiveListeners && (u = p.dom7LiveListeners[d]), u && u.length)
                        for (var h = u.length - 1; h >= 0; h -= 1) {
                            var f = u[h];
                            a && f.listener === a || a && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === a ? (p.removeEventListener(d, f.proxyListener, o), u.splice(h, 1)) : a || (p.removeEventListener(d, f.proxyListener, o), u.splice(h, 1))
                        }
                }
            return this
        },
        trigger: function() {
            for (var e = r(), t = arguments.length, i = new Array(t), s = 0; s < t; s++) i[s] = arguments[s];
        ...
        find: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1) {
                ...
                for (var n = 0; n < s.length; n += 1) t.push(s[n])
            }
            return m(t)
        },
        children: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                for (var s = this[i].children, n = 0; n < s.length; n += 1) e && !m(s[n]).is(e) || t.push(s[n]);
            return m(t)
        },
        filter: function(e) {
            return m(f(this, e))
    ...
    function S(e, t) {
        ...
        return a.WebKitCSSMatrix ? ((s = o.transform || o.webkitTransform).split(",").length > 6 && (s = s.split(", ").map(function(e) {
            return e.replace(",", ".")
        }).join(", ")), n = new a.WebKitCSSMatrix("none" === s ? "" : s)) : i = (n = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === t && (s = a.WebKitCSSMatrix ? n.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), "y" === t && (s = a.WebKitCSSMatrix ? n.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])), s || 0
    }
        ...
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], i = "undefined" != typeof window ? window.HTMLElement : void 0, s = 1; s < arguments.length; s += 1) {
            ...
            if (null != n && !(i && n instanceof i))
                for (var a = Object.keys(Object(n)).filter(function(e) {
                    ...
                    void 0 !== d && d.enumerable && (C(e[l]) && C(n[l]) ? n[l].__swiper__ ? e[l] = n[l] : T(e[l], n[l]) : !C(e[l]) && C(n[l]) ? (e[l] = {}, n[l].__swiper__ ? e[l] = n[l] : T(e[l], n[l])) : e[l] = n[l])
                }
        }
        return e
    }
    ...
    function $(e, t, i, s) {
        ...
        return i && Object.keys(s).forEach(function(i) {
            if (!t[i] && !0 === t.auto) {
                ...
                a.className = s[i], e.append(a), t[i] = a
            }
        }), t
    }
    ...
    function P(e) {
        return void 0 === e && (e = {}), g || (g = function(e) {
            var t = (void 0 === e ? {} : e).userAgent,
                ...
                f = "Win32" === n,
                m = "MacIntel" === n;
            return !p && m && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(l + "x" + d) >= 0 && ((p = a.match(/(Version)\/([\d.]+)/)) || (p = [0, 1, "13_0_0"]), m = !1), c && !f && (o.os = "android", o.android = !0), (p || h || u) && (o.os = "ios", o.ios = !0), o
        }(e)), g
    }
                            ...
                            e && !e.destroyed && e.initialized && (e.resize.observer = new ResizeObserver(function(t) {
                                ...
                                t.forEach(function(t) {
                                    var i = t.contentBoxSize,
                                        s = t.contentRect,
                                        o = t.target;
                                    o && o !== e.el || (n = s ? s.width : (i[0] || i).inlineSize, a = s ? s.height : (i[0] || i).blockSize)
    ...
    function O(e) {
        ...
        if (t.enabled && (!t.animating || !o.preventInteractionOnTransition)) {
            ...
            if (("wrapper" !== o.touchEventsTarget || c.closest(t.wrapperEl).length) && (n.isTouchEvent = "touchstart" === d.type, (n.isTouchEvent || !("which" in d) || 3 !== d.which) && !(!n.isTouchEvent && "button" in d && d.button > 0 || n.isTouched && n.isMoved)))
                if (!!o.noSwipingClass && "" !== o.noSwipingClass && d.target && d.target.shadowRoot && e.path && e.path[0] && (c = m(e.path[0])), o.noSwiping && c.closest(o.noSwipingSelector ? o.noSwipingSelector : "." + o.noSwipingClass)[0]) t.allowClick = !0;
                ...
                if (T(n, {
                        ...
                        isScrolling: void 0,
                        startMoving: void 0
                    }), l.startX = p, l.startY = u, n.touchStartTime = x(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, o.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== d.type) {
                    var v = !0;
                    c.is(n.focusableElements) && (v = !1), i.activeElement && m(i.activeElement).is(n.focusableElements) && i.activeElement !== c[0] && i.activeElement.blur();
                    var g = v && t.allowTouchMove && o.touchStartPreventDefault;
                    !o.touchStartForcePreventDefault && !g || c[0].isContentEditable || d.preventDefault()
                }
                t.emit("touchStart", d)
            }
        }
    ...
    var R = {
        ...
        j = {
            ...
            eventsEmitter: {
                ...
                emit: function() {
                    ...
                    return "string" == typeof a[0] || Array.isArray(a[0]) ? (e = a[0], t = a.slice(1, a.length), i = s) : (e = a[0].events, t = a[0].data, i = a[0].context || s), t.unshift(i), (Array.isArray(e) ? e : e.split(" ")).forEach(function(e) {
            ...
            update: {
                updateSize: function() {
                    var e, t, i = this,
                        s = i.$el;
                    e = void 0 !== i.params.width && null !== i.params.width ? i.params.width : s[0].clientWidth, t = void 0 !== i.params.height && null !== i.params.height ? i.params.height : s[0].clientHeight, 0 === e && i.isHorizontal() || 0 === t && i.isVertical() || (e = e - parseInt(s.css("padding-left") || 0, 10) - parseInt(s.css("padding-right") || 0, 10), t = t - parseInt(s.css("padding-top") || 0, 10) - parseInt(s.css("padding-bottom") || 0, 10), Number.isNaN(e) && (e = 0), Number.isNaN(t) && (t = 0), T(i, {
                        width: e,
                        height: t,
                ...
                updateSlides: function() {
                    ...
                    if (void 0 !== a) {
                        var C, E;
                        "string" == typeof y && y.indexOf("%") >= 0 && (y = parseFloat(y.replace("%", "")) / 100 * a), e.virtualSize = -y, o ? c.css({
                            marginLeft: "",
                            marginTop: ""
                        }) : c.css({
                            marginRight: "",
                        ...
                        for (var k, $, M, P = s.slidesPerColumn, z = C / P, L = Math.floor(p / s.slidesPerColumn), A = 0; A < p; A += 1) {
                            E = 0;
                            var I = c.eq(A);
                            if (s.slidesPerColumn > 1) {
                                ...
                                if ("row" === s.slidesPerColumnFill && s.slidesPerGroup > 1) {
                                    var F = Math.floor(A / (s.slidesPerGroup * s.slidesPerColumn)),
                                        R = A - s.slidesPerColumn * s.slidesPerGroup * F,
                                        j = 0 === F ? s.slidesPerGroup : Math.min(Math.ceil((p - F * P * s.slidesPerGroup) / P), s.slidesPerGroup);
                                    O = (D = R - (H = Math.floor(R / j)) * j + F * s.slidesPerGroup) + H * C / P, I.css({
                                ...
                                } else "column" === s.slidesPerColumnFill ? (H = A - (D = Math.floor(A / P)) * P, (D > L || D === L && H === P - 1) && (H += 1) >= P && (H = 0, D += 1)) : D = A - (H = Math.floor(A / z)) * z;
                                I.css(t("margin-top"), 0 !== H ? s.spaceBetween && s.spaceBetween + "px" : "")
                            }
                            if ("none" !== I.css("display")) {
                                if ("auto" === s.slidesPerView) {
                                    ...
                                    if (B && (I[0].style.transform = "none"), q && (I[0].style.webkitTransform = "none"), s.roundLengths) E = e.isHorizontal() ? I.outerWidth(!0) : I.outerHeight(!0);
                                    else {
                                        var X = i(N, "width"),
                                            Y = i(N, "padding-left"),
                                            W = i(N, "padding-right"),
                                            V = i(N, "margin-left"),
                                            G = i(N, "margin-right"),
                                            _ = N.getPropertyValue("box-sizing");
                                        if (_ && "border-box" === _) E = X + V + G;
                                        else {
                                            var U = I[0],
                                                K = U.clientWidth;
                                            E = X + Y + W + V + G + (U.offsetWidth - K)
                                        }
                                    }
                                    B && (I[0].style.transform = B), q && (I[0].style.webkitTransform = q), s.roundLengths && (E = Math.floor(E))
                                } else E = (a - (s.slidesPerView - 1) * y) / s.slidesPerView, s.roundLengths && (E = Math.floor(E)), c[A] && (c[A].style[t("width")] = E + "px");
                                c[A] && (c[A].swiperSlideSize = E), f.push(E), s.centeredSlides ? (w = w + E / 2 + x / 2 + y, 0 === x && 0 !== A && (w = w - a / 2 - y), 0 === A && (w = w - a / 2 - y), Math.abs(w) < .001 && (w = 0), s.roundLengths && (w = Math.floor(w)), S % s.slidesPerGroup == 0 && u.push(w), h.push(w)) : (s.roundLengths && (w = Math.floor(w)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(w), h.push(w), w = w + E + y), e.virtualSize += E + y, x = E, S += 1
                            }
                        }
                        if (e.virtualSize = Math.max(e.virtualSize, a) + v, o && r && ("slide" === s.effect || "coverflow" === s.effect) && n.css({
                                width: e.virtualSize + s.spaceBetween + "px"
                            }), s.setWrapperSize && n.css((($ = {})[t("width")] = e.virtualSize + s.spaceBetween + "px", $)), s.slidesPerColumn > 1 && (e.virtualSize = (E + s.spaceBetween) * C, e.virtualSize = Math.ceil(e.virtualSize / s.slidesPerColumn) - s.spaceBetween, n.css(((M = {})[t("width")] = e.virtualSize + s.spaceBetween + "px", M)), s.centeredSlides)) {
                            k = [];
                            for (var Z = 0; Z < u.length; Z += 1) {
                                var Q = u[Z];
                                s.roundLengths && (Q = Math.floor(Q)), u[Z] < e.virtualSize + u[0] && k.push(Q)
                            }
                            u = k
                        }
                        if (!s.centeredSlides) {
                            ...
                            for (var J = 0; J < u.length; J += 1) {
                                var ee = u[J];
                                s.roundLengths && (ee = Math.floor(ee)), u[J] <= e.virtualSize - a && k.push(ee)
                            }
                        ...
                        T(e, {
                            ...
                            slidesGrid: h,
                            slidesSizesGrid: f
                        }), p !== d && e.emit("slidesLengthChange"), u.length !== g && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== b && e.emit("slidesGridLengthChange"), (s.watchSlidesProgress || s.watchSlidesVisibility) && e.updateSlidesOffset()
                    }
                },
                    ...
                    if (0 !== s.length) {
                        ...
                        for (var o = 0; o < s.length; o += 1) {
                            ...
                            if (i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) {
                                ...
                                (d >= 0 && d < t.size - 1 || c > 1 && c <= t.size || d <= 0 && c >= t.size) && (t.visibleSlides.push(r), t.visibleSlidesIndexes.push(o), s.eq(o).addClass(i.slideVisibleClass))
                            }
                            r.progress = n ? -l : l
                        }
                ...
                updateProgress: function(e) {
                    ...
                    var s = t.params,
                        ...
                        l = o,
                        d = r;
                    0 === n ? (a = 0, o = !0, r = !0) : (o = (a = (e - t.minTranslate()) / n) <= 0, r = a >= 1), T(t, {
                        progress: a,
                        isBeginning: o,
                        isEnd: r
                    }), (s.watchSlidesProgress || s.watchSlidesVisibility || s.centeredSlides && s.autoHeight) && t.updateSlidesProgress(e), o && !l && t.emit("reachBeginning toEdge"), r && !d && t.emit("reachEnd toEdge"), (l && !o || d && !r) && t.emit("fromEdge"), t.emit("progress", a)
                },
                updateSlidesClasses: function() {
                    ...
                    i.removeClass(s.slideActiveClass + " " + s.slideNextClass + " " + s.slidePrevClass + " " + s.slideDuplicateActiveClass + " " + s.slideDuplicateNextClass + " " + s.slideDuplicatePrevClass), (e = r ? t.$wrapperEl.find("." + s.slideClass + '[data-swiper-slide-index="' + a + '"]') : i.eq(a)).addClass(s.slideActiveClass), s.loop && (e.hasClass(s.slideDuplicateClass) ? n.children("." + s.slideClass + ":not(." + s.slideDuplicateClass + ')[data-swiper-slide-index="' + o + '"]').addClass(s.slideDuplicateActiveClass) : n.children("." + s.slideClass + "." + s.slideDuplicateClass + '[data-swiper-slide-index="' + o + '"]').addClass(s.slideDuplicateActiveClass));
                ...
                updateActiveIndex: function(e) {
                    var t, i = this,
                        ...
                        c = e;
                    if (void 0 === c) {
                        for (var p = 0; p < n.length; p += 1) void 0 !== n[p + 1] ? s >= n[p] && s < n[p + 1] - (n[p + 1] - n[p]) / 2 ? c = p : s >= n[p] && s < n[p + 1] && (c = p + 1) : s >= n[p] && (c = p);
                ...
                updateClickedSlide: function(e) {
                    var t, i = this,
                        s = i.params,
                        n = m(e.target).closest("." + s.slideClass)[0],
                        a = !1;
                    if (n)
                    ...
                    i.clickedSlide = n, i.virtual && i.params.virtual.enabled ? i.clickedIndex = parseInt(m(n).attr("data-swiper-slide-index"), 10) : i.clickedIndex = t, s.slideToClickedSlide && void 0 !== i.clickedIndex && i.clickedIndex !== i.activeIndex && i.slideToClickedSlide()
                }
            },
            translate: {
                ...
                setTranslate: function(e, t) {
                    var i = this,
                        ...
                        l = 0,
                        d = 0;
                    i.isHorizontal() ? l = s ? -e : e : d = e, n.roundLengths && (l = Math.floor(l), d = Math.floor(d)), n.cssMode ? o[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -d : n.virtualTranslate || a.transform("translate3d(" + l + "px, " + d + "px, 0px)"), i.previousTranslate = i.translate, i.translate = i.isHorizontal() ? l : d;
                ...
                translateTo: function(e, t, i, s, n) {
                    ...
                    var l, d = a.minTranslate(),
                        c = a.maxTranslate();
                    if (l = s && e > d ? d : s && e < c ? c : e, a.updateProgress(l), o.cssMode) {
                        var p, u = a.isHorizontal();
                        return 0 === t ? r[u ? "scrollLeft" : "scrollTop"] = -l : r.scrollTo ? r.scrollTo(((p = {})[u ? "left" : "top"] = -l, p.behavior = "smooth", p)) : r[u ? "scrollLeft" : "scrollTop"] = -l, !0
                    }
            ...
            transition: {
                ...
                transitionStart: function(e, t) {
                    ...
                    if (!n.cssMode) {
                        ...
                        var o = t;
                        if (o || (o = s > a ? "next" : s < a ? "prev" : "reset"), i.emit("transitionStart"), e && s !== a) {
                ...
                transitionEnd: function(e, t) {
                    ...
                    if (i.animating = !1, !a.cssMode) {
                        i.setTransition(0);
                        var o = t;
                        if (o || (o = s > n ? "next" : s < n ? "prev" : "reset"), i.emit("transitionEnd"), e && s !== n) {
            ...
            slide: {
                slideTo: function(e, t, i, s, n) {
                    ...
                    var l = o.params,
                        ...
                        f = o.wrapperEl,
                        m = o.enabled;
                    if (o.animating && l.preventInteractionOnTransition || !m && !s && !n) return !1;
                    var v = Math.min(o.params.slidesPerGroupSkip, r),
                        g = v + Math.floor((r - v) / o.params.slidesPerGroup);
                    g >= d.length && (g = d.length - 1), (u || l.initialSlide || 0) === (p || 0) && i && o.emit("beforeSlideChangeStart");
                    var b, y = -d[g];
                    if (o.updateProgress(y), l.normalizeSlideIndex)
                        for (var w = 0; w < c.length; w += 1) {
                            var x = -Math.floor(100 * y),
                                S = Math.floor(100 * c[w]),
                                C = Math.floor(100 * c[w + 1]);
                            void 0 !== c[w + 1] ? x >= S && x < C - (C - S) / 2 ? r = w : x >= S && x < C && (r = w + 1) : x >= S && (r = w)
                        }
                    ...
                    if (b = r > u ? "next" : r < u ? "prev" : "reset", h && -y === o.translate || !h && y === o.translate) return o.updateActiveIndex(r), l.autoHeight && o.updateAutoHeight(), o.updateSlidesClasses(), "slide" !== l.effect && o.setTranslate(y), "reset" !== b && (o.transitionStart(i, b), o.transitionEnd(i, b)), !1;
                    if (l.cssMode) {
                        var T, E = o.isHorizontal(),
                            k = -y;
                        return h && (k = f.scrollWidth - f.offsetWidth - k), 0 === t ? f[E ? "scrollLeft" : "scrollTop"] = k : f.scrollTo ? f.scrollTo(((T = {})[E ? "left" : "top"] = k, T.behavior = "smooth", T)) : f[E ? "scrollLeft" : "scrollTop"] = k, !0
                    }
                ...
                slideNext: function(e, t, i) {
                    ...
                    var o = s.activeIndex < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup;
                    if (n.loop) {
                        if (a && n.loopPreventsSlide) return !1;
                        s.loopFix(), s._clientLeft = s.$wrapperEl[0].clientLeft
                    }
                    return s.slideTo(s.activeIndex + o, e, t, i)
                },
                slidePrev: function(e, t, i) {
                    ...
                    var c, p = d(l ? s.translate : -s.translate),
                        u = o.map(function(e) {
                            return d(e)
                        }),
                        h = o[u.indexOf(p) - 1];
                    return void 0 === h && n.cssMode && o.forEach(function(e) {
                        !h && p >= e && (h = e)
                    }), void 0 !== h && (c = r.indexOf(h)) < 0 && (c = s.activeIndex - 1), s.slideTo(c, e, t, i)
                },
                ...
                slideToClosest: function(e, t, i, s) {
                    ...
                    if (l >= n.snapGrid[r]) {
                        var d = n.snapGrid[r];
                        l - d > (n.snapGrid[r + 1] - d) * s && (a += n.params.slidesPerGroup)
                    } else {
                        var c = n.snapGrid[r - 1];
                        l - c <= (n.snapGrid[r] - c) * s && (a -= n.params.slidesPerGroup)
                    }
                ...
                slideToClickedSlide: function() {
                    ...
                    if (i.loop) {
                        ...
                        e = parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? a < t.loopedSlides - n / 2 || a > t.slides.length - t.loopedSlides + n / 2 ? (t.loopFix(), a = s.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), w(function() {
                            t.slideTo(a)
                        })) : t.slideTo(a) : a > t.slides.length - n ? (t.loopFix(), a = s.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), w(function() {
                            t.slideTo(a)
                        })) : t.slideTo(a)
                    } else t.slideTo(a)
                }
            ...
            loop: {
                loopCreate: function() {
                    ...
                    for (var p = 0; p < c.length; p += 1) s.append(m(c[p].cloneNode(!0)).addClass(i.slideDuplicateClass));
                ...
                loopFix: function() {
                    ...
                    i < n ? (t = s.length - 3 * n + i, t += n, e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)) : i >= s.length - n && (t = -s.length + i + n, t += n, e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)), e.allowSlidePrev = a, e.allowSlideNext = o, e.emit("loopFix")
                },
            ...
            manipulation: {
                ...
                addSlide: function(e, t) {
                    ...
                    if (e <= 0) i.prependSlide(t);
                        ...
                        for (var r = a > e ? a + 1 : a, l = [], d = o - 1; d >= e; d -= 1) {
                            var c = i.slides.eq(d);
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = O.bind(e), e.onTouchMove = function(e) {
                        ...
                        if (i.enabled) {
                            ...
                            if (l.originalEvent && (l = l.originalEvent), s.isTouched) {
                                if (!s.isTouchEvent || "touchmove" === l.type) {
                                    ...
                                    if (l.preventedByNestedSwiper) return o.startX = c, void(o.startY = p);
                                    if (!i.allowTouchMove) return i.allowClick = !1, void(s.isTouched && (T(o, {
                                        startX: c,
                                        startY: p,
                                        currentX: c,
                                        currentY: p
                                    ...
                                    if (s.isTouchEvent && t.activeElement && l.target === t.activeElement && m(l.target).is(s.focusableElements)) return s.isMoved = !0, void(i.allowClick = !1);
                                    if (s.allowTouchCallbacks && i.emit("touchMove", l), !(l.targetTouches && l.targetTouches.length > 1)) {
                                        ...
                                        if (!(i.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(f, 2)) < i.params.threshold))
                                            if (void 0 === s.isScrolling && (i.isHorizontal() && o.currentY === o.startY || i.isVertical() && o.currentX === o.startX ? s.isScrolling = !1 : h * h + f * f >= 25 && (u = 180 * Math.atan2(Math.abs(f), Math.abs(h)) / Math.PI, s.isScrolling = i.isHorizontal() ? u > n.touchAngle : 90 - u > n.touchAngle)), s.isScrolling && i.emit("touchMoveOpposite", l), void 0 === s.startMoving && (o.currentX === o.startX && o.currentY === o.startY || (s.startMoving = !0)), s.isScrolling) s.isTouched = !1;
                                            ...
                                            o.diff = v, v *= n.touchRatio, r && (v = -v), i.swipeDirection = v > 0 ? "prev" : "next", s.currentTranslate = v + s.startTranslate;
                                            var g = !0,
                                                b = n.resistanceRatio;
                                            if (n.touchReleaseOnEdges && (b = 0), v > 0 && s.currentTranslate > i.minTranslate() ? (g = !1, n.resistance && (s.currentTranslate = i.minTranslate() - 1 + Math.pow(-i.minTranslate() + s.startTranslate + v, b))) : v < 0 && s.currentTranslate < i.maxTranslate() && (g = !1, n.resistance && (s.currentTranslate = i.maxTranslate() + 1 - Math.pow(i.maxTranslate() - s.startTranslate - v, b))), g && (l.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), i.allowSlidePrev || i.allowSlideNext || (s.currentTranslate = s.startTranslate), n.threshold > 0) {
                        ...
                        if (t.enabled) {
                            ...
                            if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), u < 300 && p - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), i.lastClickTime = x(), w(function() {
                            ...
                            if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, c = s.followFinger ? a ? t.translate : -t.translate : -i.currentTranslate, !s.cssMode)
                                if (s.freeMode) {
                                    ...
                                    if (s.freeModeMomentum) {
                                        if (i.velocities.length > 1) {
                                            var h = i.velocities.pop(),
                                                ...
                                                v = h.time - f.time;
                                            t.velocity = m / v, t.velocity /= 2, Math.abs(t.velocity) < s.freeModeMinimumVelocity && (t.velocity = 0), (v > 150 || x() - h.time > 300) && (t.velocity = 0)
                                        } else t.velocity = 0;
                                        ...
                                        if (y < t.maxTranslate()) s.freeModeMomentumBounce ? (y + t.maxTranslate() < -E && (y = t.maxTranslate() - E), S = t.maxTranslate(), T = !0, i.allowMomentumBounce = !0) : y = t.maxTranslate(), s.loop && s.centeredSlides && (C = !0);
                                        else if (y > t.minTranslate()) s.freeModeMomentumBounce ? (y - t.minTranslate() > E && (y = t.minTranslate() + E), S = t.minTranslate(), T = !0, i.allowMomentumBounce = !0) : y = t.minTranslate(), s.loop && s.centeredSlides && (C = !0);
                                        ...
                                        if (C && t.once("transitionEnd", function() {
                                            ...
                                            if (g = a ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity), s.freeModeSticky) {
                                                var M = Math.abs((a ? -y : y) - t.translate),
                                                    P = t.slidesSizesGrid[t.activeIndex];
                                                g = M < P ? s.speed : M < 2 * P ? 1.5 * s.speed : 2.5 * s.speed
                                            }
                                        } else if (s.freeModeSticky) return void t.slideToClosest();
                                        s.freeModeMomentumBounce && T ? (t.updateProgress(S), t.setTransition(g), t.setTranslate(y), t.transitionStart(!0, t.swipeDirection), t.animating = !0, o.transitionEnd(function() {
                                    ...
                                    for (var z = 0, L = t.slidesSizesGrid[0], A = 0; A < r.length; A += A < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup) {
                                        var I = A < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
                                        void 0 !== r[A + I] ? c >= r[A] && c < r[A + I] && (z = A, L = r[A + I] - r[A]) : c >= r[A] && (z = A, L = r[r.length - 1] - r[r.length - 2])
                                    }
                                    var O = (c - r[z]) / L,
                    ...
                    var d = !!i.nested;
                    if (!l.touch && l.pointerEvents) n.addEventListener(s.start, e.onTouchStart, !1), t.addEventListener(s.move, e.onTouchMove, d), t.addEventListener(s.end, e.onTouchEnd, !1);
                    else {
                        if (l.touch) {
                            var c = !("touchstart" !== s.start || !l.passiveListener || !i.passiveListeners) && {
                                passive: !0,
                                capture: !1
                            };
                            n.addEventListener(s.start, e.onTouchStart, c), n.addEventListener(s.move, e.onTouchMove, l.passiveListener ? {
                                passive: !1,
                                capture: d
                            } : d), n.addEventListener(s.end, e.onTouchEnd, c), s.cancel && n.addEventListener(s.cancel, e.onTouchEnd, c), H || (t.addEventListener("touchstart", F), H = !0)
                        }(i.simulateTouch && !r.ios && !r.android || i.simulateTouch && !l.touch && r.ios) && (n.addEventListener("mousedown", e.onTouchStart, !1), t.addEventListener("mousemove", e.onTouchMove, d), t.addEventListener("mouseup", e.onTouchEnd, !1))
                    }(i.preventClicks || i.preventClicksPropagation) && n.addEventListener("click", e.onClick, !0), i.cssMode && o.addEventListener("scroll", e.onScroll), i.updateOnWindowResize ? e.on(r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D, !0) : e.on("observerUpdate", D, !0)
                },
                detachEvents: function() {
                    var e = this,
                        ...
                        l = e.support,
                        d = !!i.nested;
                    if (!l.touch && l.pointerEvents) n.removeEventListener(s.start, e.onTouchStart, !1), t.removeEventListener(s.move, e.onTouchMove, d), t.removeEventListener(s.end, e.onTouchEnd, !1);
                    else {
                        if (l.touch) {
                            var c = !("onTouchStart" !== s.start || !l.passiveListener || !i.passiveListeners) && {
                                passive: !0,
                                capture: !1
                            };
                            n.removeEventListener(s.start, e.onTouchStart, c), n.removeEventListener(s.move, e.onTouchMove, d), n.removeEventListener(s.end, e.onTouchEnd, c), s.cancel && n.removeEventListener(s.cancel, e.onTouchEnd, c)
                        }(i.simulateTouch && !r.ios && !r.android || i.simulateTouch && !l.touch && r.ios) && (n.removeEventListener("mousedown", e.onTouchStart, !1), t.removeEventListener("mousemove", e.onTouchMove, d), t.removeEventListener("mouseup", e.onTouchEnd, !1))
                    }(i.preventClicks || i.preventClicksPropagation) && n.removeEventListener("click", e.onClick, !0), i.cssMode && o.removeEventListener("scroll", e.onScroll), e.off(r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D)
                }
            },
            breakpoints: {
                    ...
                    if (r && (!r || 0 !== Object.keys(r).length)) {
                        ...
                        if (l && e.currentBreakpoint !== l) {
                            ...
                            var c = d || e.originalParams,
                                ...
                                h = a.enabled;
                            p && !u ? (o.removeClass(a.containerModifierClass + "multirow " + a.containerModifierClass + "multirow-column"), e.emitContainerClasses()) : !p && u && (o.addClass(a.containerModifierClass + "multirow"), "column" === c.slidesPerColumnFill && o.addClass(a.containerModifierClass + "multirow-column"), e.emitContainerClasses());
                            ...
                            }), h && !v ? e.disable() : !h && v && e.enable(), e.currentBreakpoint = l, e.emit("_beforeBreakpoint", c), m && i && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - n + e.loopedSlides, 0, !1)), e.emit("breakpoint", c)
                        }
                    }
                },
                    ...
                    if (void 0 === t && (t = "window"), e && ("container" !== t || i)) {
                        ...
                        for (var l = 0; l < o.length; l += 1) {
                            var d = o[l],
                                c = d.point,
                                p = d.value;
                            "window" === t ? n.matchMedia("(min-width: " + p + "px)").matches && (s = c) : p <= i.clientWidth && (s = c)
                        }
                        return s || "max"
                    }
                }
            ...
            classes: {
                addClasses: function() {
                    ...
                    n.push.apply(n, c), r.addClass([].concat(n).join(" ")), s.emitContainerClasses()
                },
            ...
            images: {
                loadImage: function(e, t, i, s, n, a) {
                    ...
                    m(e).parent("picture")[0] || e.complete && n ? d() : t ? ((o = new l.Image).onload = d, o.onerror = d, s && (o.sizes = s), i && (o.srcset = i), t && (o.src = t)) : d()
                },
        ...
        B = function() {
            function t() {
                ...
                if (1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? i = n[0] : (e = n[0], i = n[1]), i || (i = {}), i = T({}, i), e && !i.el && (i.el = e), i.el && m(i.el).length > 1) {
                    var o = [];
                ...
                }), r.browser = z(), r.eventsListeners = {}, r.eventsAnyListeners = [], void 0 === r.modules && (r.modules = {}), Object.keys(r.modules).forEach(function(e) {
                    var t = r.modules[e];
                    if (t.params) {
                ...
                var l, d, c = T({}, R);
                return r.useParams(c), r.params = T({}, c, N, i), r.originalParams = T({}, r.params), r.passedParams = T({}, i), r.params && r.params.on && Object.keys(r.params.on).forEach(function(e) {
                    ...
                    touchEvents: (l = ["touchstart", "touchmove", "touchend", "touchcancel"], d = ["mousedown", "mousemove", "mouseup"], r.support.pointerEvents && (d = ["pointerdown", "pointermove", "pointerup"]), r.touchEventsTouch = {
                        start: l[0],
                        move: l[1],
                        end: l[2],
                        cancel: l[3]
            ...
            return n.enable = function() {
                ...
                var e = this,
                    ...
                    o = 1;
                if (t.centeredSlides) {
                    for (var r, l = i[a].swiperSlideSize, d = a + 1; d < i.length; d += 1) i[d] && !r && (o += 1, (l += i[d].swiperSlideSize) > n && (r = !0));
                    for (var c = a - 1; c >= 0; c -= 1) i[c] && !r && (o += 1, (l += i[c].swiperSlideSize) > n && (r = !0))
                } else
                    for (var p = a + 1; p < i.length; p += 1) s[p] - s[a] < n && (o += 1);
                return o
            }, n.update = function() {
                var e = this;
                if (e && !e.destroyed) {
                ...
                return e || (e = "horizontal" === s ? "vertical" : "horizontal"), e === s || "horizontal" !== e && "vertical" !== e || (i.$el.removeClass("" + i.params.containerModifierClass + s).addClass("" + i.params.containerModifierClass + e), i.emitContainerClasses(), i.params.direction = e, i.slides.each(function(t) {
                ...
                var s = function() {
                    ...
                    n = function() {
                        if (e && e.shadowRoot && e.shadowRoot.querySelector) {
                            var t = m(e.shadowRoot.querySelector(s()));
                ...
                if (0 === n.length && t.params.createElements) {
                    ...
                    n = m(o), o.className = t.params.wrapperClass, i.append(o), i.children("." + t.params.slideClass).each(function(e) {
                        n.append(e)
                    })
                }
                return T(t, {
    ...
    var q = {
            update: function(e) {
                ...
                v = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", a ? (g = Math.floor(s / 2) + n + l, b = Math.floor(s / 2) + n + r) : (g = s + (n - 1) + l, b = n + r);
                var w = Math.max((y || 0) - b, 0),
                    x = Math.min((y || 0) + g, u.length - 1),
                ...
                if (T(t.virtual, {
                    ...
                    }), c === w && p === x && !e) return t.slidesGrid !== h && S !== m && t.slides.css(v, S + "px"), void t.updateProgress();
                ...
                if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                    ...
                    for (var $ = c; $ <= p; $ += 1)($ < w || $ > x) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + $ + '"]').remove();
                for (var M = 0; M < u.length; M += 1) M >= w && M <= x && (void 0 === p || e ? k.push(M) : (M > p && k.push(M), M < c && E.push(M)));
            ...
            renderSlide: function(e, t) {
                ...
                var n = s.renderSlide ? m(s.renderSlide.call(i, e, t)) : m('<div class="' + i.params.slideClass + '" data-swiper-slide-index="' + t + '">' + e + "</div>");
            ...
            removeSlide: function(e) {
                ...
                if (null != e) {
                    var i = t.activeIndex;
                    if (Array.isArray(e))
                        for (var s = e.length - 1; s >= 0; s -= 1) t.virtual.slides.splice(e[s], 1), t.params.virtual.cache && delete t.virtual.cache[e[s]], e[s] < i && (i -= 1), i = Math.max(i, 0);
            ...
            handle: function(e) {
                ...
                if (t.enabled) {
                    ...
                    if (!(o.shiftKey || o.altKey || o.ctrlKey || o.metaKey || s.activeElement && s.activeElement.nodeName && ("input" === s.activeElement.nodeName.toLowerCase() || "textarea" === s.activeElement.nodeName.toLowerCase()))) {
                        ...
                        t.isHorizontal() ? ((c || p || u || h) && (o.preventDefault ? o.preventDefault() : o.returnValue = !1), ((p || h) && !n || (c || u) && n) && t.slideNext(), ((c || u) && !n || (p || h) && n) && t.slidePrev()) : ((c || p || f || m) && (o.preventDefault ? o.preventDefault() : o.returnValue = !1), (p || m) && t.slideNext(), (c || f) && t.slidePrev()), t.emit("keyPress", l)
                    }
                }
            },
            enable: function() {
        ...
        V = {
            ...
            event: function() {
                return r().navigator.userAgent.indexOf("firefox") > -1 ? "DOMMouseScroll" : function() {
                    ...
                    if (!i) {
                        ...
                        s.setAttribute(t, "return;"), i = "function" == typeof s.onwheel
                    }
            ...
            handle: function(e) {
                ...
                if (i.enabled) {
                    ...
                    var n = i.$el;
                    if ("container" !== i.params.mousewheel.eventsTarget && (n = m(i.params.mousewheel.eventsTarget)), !i.mouseEntered && !n[0].contains(t.target) && !s.releaseOnEdges) return !0;
                    ...
                    if (l >= i.minTranslate() && (l = i.minTranslate()), l <= i.maxTranslate() && (l = i.maxTranslate()), (!!i.params.loop || !(l === i.minTranslate() || l === i.maxTranslate())) && i.params.nested && t.stopPropagation(), i.params.freeMode) {
                        ...
                        if (!p) {
                            ...
                            if (u >= i.minTranslate() && (u = i.minTranslate()), u <= i.maxTranslate() && (u = i.maxTranslate()), i.setTransition(0), i.setTranslate(u), i.updateProgress(), i.updateActiveIndex(), i.updateSlidesClasses(), (!h && i.isBeginning || !f && i.isEnd) && i.updateSlidesClasses(), i.params.freeModeSticky) {
                                ...
                                if (v.push(d), g && (d.delta > g.delta || d.direction !== g.direction)) v.splice(0);
                                    ...
                                    var y = a > 0 ? .8 : .2;
                                    i.mousewheel.lastEventBeforeSnap = d, v.splice(0), i.mousewheel.timeout = w(function() {
                        ...
                        if (C.push(S), T ? (S.direction !== T.direction || S.delta > T.delta || S.time > T.time + 150) && i.mousewheel.animateSlider(S) : i.mousewheel.animateSlider(S), i.mousewheel.releaseScroll(S)) return !0
                    }
        ...
        G = {
            ...
            init: function() {
                ...
                i.params.navigation = $(i.$el, i.params.navigation, i.params.createElements, {
                    nextEl: "swiper-button-next",
                    prevEl: "swiper-button-prev"
                }), (s.nextEl || s.prevEl) && (s.nextEl && (e = m(s.nextEl), i.params.uniqueNavElements && "string" == typeof s.nextEl && e.length > 1 && 1 === i.$el.find(s.nextEl).length && (e = i.$el.find(s.nextEl))), s.prevEl && (t = m(s.prevEl), i.params.uniqueNavElements && "string" == typeof s.prevEl && t.length > 1 && 1 === i.$el.find(s.prevEl).length && (t = i.$el.find(s.prevEl))), e && e.length > 0 && e.on("click", i.navigation.onNextClick), t && t.length > 0 && t.on("click", i.navigation.onPrevClick), T(i.navigation, {
                    $nextEl: e,
                    nextEl: e && e[0],
                    $prevEl: t,
                    prevEl: t && t[0]
        ...
        _ = {
            update: function() {
                ...
                if (i.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if (e.params.loop ? ((s = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > n - 1 - 2 * e.loopedSlides && (s -= n - 2 * e.loopedSlides), s > o - 1 && (s -= o), s < 0 && "bullets" !== e.params.paginationType && (s = o + s)) : s = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === i.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                        var r, l, d, c = e.pagination.bullets;
                        if (i.dynamicBullets && (e.pagination.bulletSize = c.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), a.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (i.dynamicMainBullets + 4) + "px"), i.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += s - e.previousIndex, e.pagination.dynamicBulletIndex > i.dynamicMainBullets - 1 ? e.pagination.dynamicBulletIndex = i.dynamicMainBullets - 1 : e.pagination.dynamicBulletIndex < 0 && (e.pagination.dynamicBulletIndex = 0)), r = s - e.pagination.dynamicBulletIndex, d = ((l = r + (Math.min(c.length, i.dynamicMainBullets) - 1)) + r) / 2), c.removeClass(i.bulletActiveClass + " " + i.bulletActiveClass + "-next " + i.bulletActiveClass + "-next-next " + i.bulletActiveClass + "-prev " + i.bulletActiveClass + "-prev-prev " + i.bulletActiveClass + "-main"), a.length > 1) c.each(function(e) {
                            var t = m(e),
                                n = t.index();
                            n === s && t.addClass(i.bulletActiveClass), i.dynamicBullets && (n >= r && n <= l && t.addClass(i.bulletActiveClass + "-main"), n === r && t.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"), n === l && t.next().addClass(i.bulletActiveClass + "-next").next().addClass(i.bulletActiveClass + "-next-next"))
                        });
                        else {
                            var p = c.eq(s),
                                u = p.index();
                            if (p.addClass(i.bulletActiveClass), i.dynamicBullets) {
                                for (var h = c.eq(r), f = c.eq(l), v = r; v <= l; v += 1) c.eq(v).addClass(i.bulletActiveClass + "-main");
                                if (e.params.loop)
                                    if (u >= c.length - i.dynamicMainBullets) {
                                        for (var g = i.dynamicMainBullets; g >= 0; g -= 1) c.eq(c.length - g).addClass(i.bulletActiveClass + "-main");
                        ...
                        if (i.dynamicBullets) {
                            var b = Math.min(c.length, i.dynamicMainBullets + 4),
                                y = (e.pagination.bulletSize * b - e.pagination.bulletSize) / 2 - d * e.pagination.bulletSize,
                                w = t ? "right" : "left";
                            c.css(e.isHorizontal() ? w : "top", y + "px")
                        }
                    }
                    if ("fraction" === i.type && (a.find(k(i.currentClass)).text(i.formatFractionCurrent(s + 1)), a.find(k(i.totalClass)).text(i.formatFractionTotal(o))), "progressbar" === i.type) {
                        var x;
                        x = i.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                        var S = (s + 1) / o,
                            C = 1,
                            T = 1;
                        "horizontal" === x ? C = S : T = S, a.find(k(i.progressbarFillClass)).transform("translate3d(0,0,0) scaleX(" + C + ") scaleY(" + T + ")").transition(e.params.speed)
                    }
                    "custom" === i.type && i.renderCustom ? (a.html(i.renderCustom(e, s + 1, o)), e.emit("paginationRender", a[0])) : e.emit("paginationUpdate", a[0]), e.params.watchOverflow && e.enabled && a[e.isLocked ? "addClass" : "removeClass"](i.lockClass)
                }
            },
            render: function() {
                var e = this,
                ...
                if (t.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if ("bullets" === t.type) {
                        ...
                        s.html(n), e.pagination.bullets = s.find(k(t.bulletClass))
                    }
            ...
            init: function() {
                var e = this;
                e.params.pagination = $(e.$el, e.params.pagination, e.params.createElements, {
            ...
            destroy: function() {
                ...
                if (t.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    i.removeClass(t.hiddenClass), i.removeClass(t.modifierClass + t.type), e.pagination.bullets && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && i.off("click", k(t.bulletClass))
                }
            }
        },
        U = {
            setTranslate: function() {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    var t = e.scrollbar,
                        ...
                        d = n,
                        c = (a - n) * s;
                    i ? (c = -c) > 0 ? (d = n - c, c = 0) : -c + n > a && (d = a + c) : c < 0 ? (d = n + c, c = 0) : c + n > a && (d = a - c), e.isHorizontal() ? (o.transform("translate3d(" + c + "px, 0, 0)"), o[0].style.width = d + "px") : (o.transform("translate3d(0px, " + c + "px, 0)"), o[0].style.height = d + "px"), l.hide && (clearTimeout(e.scrollbar.timeout), r[0].style.opacity = 1, e.scrollbar.timeout = setTimeout(function() {
            ...
            updateSize: function() {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    ...
                    var n, a = e.isHorizontal() ? s[0].offsetWidth : s[0].offsetHeight,
                        ...
                        r = o * (a / e.size);
                    n = "auto" === e.params.scrollbar.dragSize ? a * o : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? i[0].style.width = n + "px" : i[0].style.height = n + "px", s[0].style.display = o >= 1 ? "none" : "", e.params.scrollbar.hide && (s[0].style.opacity = 0), T(t, {
                        trackSize: a,
                        divider: o,
                        moveDivider: r,
                        dragSize: n
            ...
            onDragMove: function(e) {
                var t = this,
                    ...
                    n = i.$el,
                    a = i.$dragEl;
                t.scrollbar.isTouched && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, i.setDragPosition(e), s.transition(0), n.transition(0), a.transition(0), t.emit("scrollbarDragMove", e))
            },
            onDragEnd: function(e) {
                var t = this,
                    ...
                    n = t.$wrapperEl,
                    a = s.$el;
                t.scrollbar.isTouched && (t.scrollbar.isTouched = !1, t.params.cssMode && (t.$wrapperEl.css("scroll-snap-type", ""), n.transition("")), i.hide && (clearTimeout(t.scrollbar.dragTimeout), t.scrollbar.dragTimeout = w(function() {
            ...
            enableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    l && (r.touch ? (l.addEventListener(s.start, e.scrollbar.onDragStart, d), l.addEventListener(s.move, e.scrollbar.onDragMove, d), l.addEventListener(s.end, e.scrollbar.onDragEnd, c)) : (l.addEventListener(n.start, e.scrollbar.onDragStart, d), t.addEventListener(n.move, e.scrollbar.onDragMove, d), t.addEventListener(n.end, e.scrollbar.onDragEnd, c)))
                }
            },
            disableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    l && (r.touch ? (l.removeEventListener(s.start, e.scrollbar.onDragStart, d), l.removeEventListener(s.move, e.scrollbar.onDragMove, d), l.removeEventListener(s.end, e.scrollbar.onDragEnd, c)) : (l.removeEventListener(n.start, e.scrollbar.onDragStart, d), t.removeEventListener(n.move, e.scrollbar.onDragMove, d), t.removeEventListener(n.end, e.scrollbar.onDragEnd, c)))
                }
            },
            init: function() {
                var e = this,
                    t = e.scrollbar,
                    i = e.$el;
                e.params.scrollbar = $(i, e.params.scrollbar, e.params.createElements, {
                    el: "swiper-scrollbar"
                });
                ...
                if (s.el) {
                    ...
                    0 === a.length && (a = m('<div class="' + e.params.scrollbar.dragClass + '"></div>'), n.append(a)), T(t, {
                        $el: n,
                        el: n[0],
                        $dragEl: a,
                        dragEl: a[0]
                    }), s.draggable && t.enableDraggable(), n && n[e.enabled ? "removeClass" : "addClass"](e.params.scrollbar.lockClass)
                }
            },
            destroy: function() {
        ...
        K = {
            setTransform: function(e, t) {
                ...
                if (o || r ? (o = o || "0", r = r || "0") : this.isHorizontal() ? (o = a, r = "0") : (r = a, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * t * n + "%" : o * t * n + "px", r = r.indexOf("%") >= 0 ? parseInt(r, 10) * t + "%" : r * t + "px", null != d) {
            ...
            setTranslate: function() {
                ...
                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(t) {
                    ...
                    var a = t.progress;
                    e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (a += Math.ceil(i / 2) - s * (n.length - 1)), a = Math.min(Math.max(a, -1), 1), m(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(t) {
        ...
        Z = {
            ...
            onGestureStart: function(e) {
                ...
                if (n.fakeGestureTouched = !1, n.fakeGestureMoved = !1, !i.gestures) {
                    ...
                    n.fakeGestureTouched = !0, a.scaleStart = Z.getDistanceBetweenTouches(e)
                }
            ...
            onGestureChange: function(e) {
                ...
                if (!i.gestures) {
                    ...
                    n.fakeGestureMoved = !0, a.scaleMove = Z.getDistanceBetweenTouches(e)
                }
            ...
            onGestureEnd: function(e) {
                ...
                o.$imageEl && 0 !== o.$imageEl.length && (a.scale = Math.max(Math.min(a.scale, o.maxRatio), n.minRatio), o.$imageEl.transition(t.params.speed).transform("translate3d(0,0,0) scale(" + a.scale + ")"), a.currentScale = a.scale, a.isScaling = !1, 1 === a.scale && (o.$slideEl = void 0))
            },
            ...
            onTouchMove: function(e) {
                ...
                if (s.$imageEl && 0 !== s.$imageEl.length && (t.allowClick = !1, n.isTouched && s.$slideEl)) {
                    n.isMoved || (n.width = s.$imageEl[0].offsetWidth, n.height = s.$imageEl[0].offsetHeight, n.startX = S(s.$imageWrapEl[0], "x") || 0, n.startY = S(s.$imageWrapEl[0], "y") || 0, s.slideWidth = s.$slideEl[0].offsetWidth, s.slideHeight = s.$slideEl[0].offsetHeight, s.$imageWrapEl.transition(0), t.rtl && (n.startX = -n.startX, n.startY = -n.startY));
                    var o = n.width * i.scale,
                        r = n.height * i.scale;
                    if (!(o < s.slideWidth && r < s.slideHeight)) {
                        if (n.minX = Math.min(s.slideWidth / 2 - o / 2, 0), n.maxX = -n.minX, n.minY = Math.min(s.slideHeight / 2 - r / 2, 0), n.maxY = -n.minY, n.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, n.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !n.isMoved && !i.isScaling) {
            ...
            in: function(e) {
                var t, i, s, n, a, o, l, d, c, p, u, h, f, v, g, b, y = this,
                    w = r(),
                    x = y.zoom,
                    S = y.params.zoom,
                    C = x.gesture,
                    T = x.image;
                C.$slideEl || (e && e.target && (C.$slideEl = m(e.target).closest("." + y.params.slideClass)), C.$slideEl || (y.params.virtual && y.params.virtual.enabled && y.virtual ? C.$slideEl = y.$wrapperEl.children("." + y.params.slideActiveClass) : C.$slideEl = y.slides.eq(y.activeIndex)), C.$imageEl = C.$slideEl.find("img, svg, canvas, picture, .swiper-zoom-target"), C.$imageWrapEl = C.$imageEl.parent("." + S.containerClass)), C.$imageEl && 0 !== C.$imageEl.length && C.$imageWrapEl && 0 !== C.$imageWrapEl.length && (C.$slideEl.addClass("" + S.zoomedSlideClass), void 0 === T.touchesStart.x && e ? (t = "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX, i = "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY) : (t = T.touchesStart.x, i = T.touchesStart.y), x.scale = C.$imageWrapEl.attr("data-swiper-zoom") || S.maxRatio, x.currentScale = C.$imageWrapEl.attr("data-swiper-zoom") || S.maxRatio, e ? (g = C.$slideEl[0].offsetWidth, b = C.$slideEl[0].offsetHeight, s = C.$slideEl.offset().left + w.scrollX + g / 2 - t, n = C.$slideEl.offset().top + w.scrollY + b / 2 - i, l = C.$imageEl[0].offsetWidth, d = C.$imageEl[0].offsetHeight, c = l * x.scale, p = d * x.scale, f = -(u = Math.min(g / 2 - c / 2, 0)), v = -(h = Math.min(b / 2 - p / 2, 0)), (a = s * x.scale) < u && (a = u), a > f && (a = f), (o = n * x.scale) < h && (o = h), o > v && (o = v)) : (a = 0, o = 0), C.$imageWrapEl.transition(300).transform("translate3d(" + a + "px, " + o + "px,0)"), C.$imageEl.transition(300).transform("translate3d(0,0,0) scale(" + x.scale + ")"))
            },
            out: function() {
                var e = this,
                    t = e.zoom,
            ...
            toggleGestures: function(e) {
                var t = this,
                    ...
                    s = i.slideSelector,
                    n = i.passiveListener;
                t.$wrapperEl[e]("gesturestart", s, i.onGestureStart, n), t.$wrapperEl[e]("gesturechange", s, i.onGestureChange, n), t.$wrapperEl[e]("gestureend", s, i.onGestureEnd, n)
            },
            ...
            enable: function() {
                ...
                if (!i.enabled) {
                    i.enabled = !0;
                    var s = !("touchstart" !== e.touchEvents.start || !t.passiveListener || !e.params.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        },
                        n = !t.passiveListener || {
                    ...
                    e.zoom.passiveListener = s, e.zoom.slideSelector = a, t.gestures ? (e.$wrapperEl.on(e.touchEvents.start, e.zoom.enableGestures, s), e.$wrapperEl.on(e.touchEvents.end, e.zoom.disableGestures, s)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.on(e.touchEvents.start, a, i.onGestureStart, s), e.$wrapperEl.on(e.touchEvents.move, a, i.onGestureChange, n), e.$wrapperEl.on(e.touchEvents.end, a, i.onGestureEnd, s), e.touchEvents.cancel && e.$wrapperEl.on(e.touchEvents.cancel, a, i.onGestureEnd, s)), e.$wrapperEl.on(e.touchEvents.move, "." + e.params.zoom.containerClass, i.onTouchMove, n)
                }
            },
            disable: function() {
                var e = this,
                ...
                if (t.enabled) {
                    var i = e.support;
                    e.zoom.enabled = !1;
                    var s = !("touchstart" !== e.touchEvents.start || !i.passiveListener || !e.params.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        },
                        n = !i.passiveListener || {
                        ...
                        a = "." + e.params.slideClass;
                    i.gestures ? (e.$wrapperEl.off(e.touchEvents.start, e.zoom.enableGestures, s), e.$wrapperEl.off(e.touchEvents.end, e.zoom.disableGestures, s)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.off(e.touchEvents.start, a, t.onGestureStart, s), e.$wrapperEl.off(e.touchEvents.move, a, t.onGestureChange, n), e.$wrapperEl.off(e.touchEvents.end, a, t.onGestureEnd, s), e.touchEvents.cancel && e.$wrapperEl.off(e.touchEvents.cancel, a, t.onGestureEnd, s)), e.$wrapperEl.off(e.touchEvents.move, "." + e.params.zoom.containerClass, t.onTouchMove, n)
                }
            }
        },
        Q = {
                ...
                if (void 0 !== e && 0 !== i.slides.length) {
                    ...
                    !n.hasClass(s.elementClass) || n.hasClass(s.loadedClass) || n.hasClass(s.loadingClass) || a.push(n[0]), 0 !== a.length && a.each(function(e) {
                        ...
                        var o = a.attr("data-background"),
                            ...
                            d = a.attr("data-sizes"),
                            c = a.parent("picture");
                        i.loadImage(a[0], r || o, l, d, !1, function() {
                            if (null != i && i && (!i || i.params) && !i.destroyed) {
                                if (o ? (a.css("background-image", 'url("' + o + '")'), a.removeAttr("data-background")) : (l && (a.attr("srcset", l), a.removeAttr("data-srcset")), d && (a.attr("sizes", d), a.removeAttr("data-sizes")), c.length && c.children("source").each(function(e) {
                                        var t = m(e);
                                        t.attr("data-srcset") && (t.attr("srcset", t.attr("data-srcset")), t.removeAttr("data-srcset"))
                                    }), r && (a.attr("src", r), a.removeAttr("data-src"))), a.addClass(s.loadedClass).removeClass(s.loadingClass), n.find("." + s.preloaderClass).remove(), i.params.loop && t) {
            ...
            load: function() {
                ...
                if ("auto" === r && (r = 0), e.lazy.initialImageLoaded || (e.lazy.initialImageLoaded = !0), e.params.watchSlidesVisibility) t.children("." + i.slideVisibleClass).each(function(t) {
                    ...
                    for (var c = n; c < n + r; c += 1) l(c) && e.lazy.loadInSlide(c);
                else e.lazy.loadInSlide(n);
                if (o.loadPrevNext)
                    if (r > 1 || o.loadPrevNextAmount && o.loadPrevNextAmount > 1) {
                        for (var p = o.loadPrevNextAmount, u = r, h = Math.min(n + u + Math.max(p, u), s.length), f = Math.max(n - Math.max(u, p), 0), v = n + r; v < h; v += 1) l(v) && e.lazy.loadInSlide(v);
            ...
            checkInViewOnLoad: function() {
                ...
                if (t && !t.destroyed) {
                    ...
                    l ? (t.lazy.load(), i.off("scroll", t.lazy.checkInViewOnLoad, u)) : t.lazy.scrollHandlerAttached || (t.lazy.scrollHandlerAttached = !0, i.on("scroll", t.lazy.checkInViewOnLoad, u))
                }
            }
        },
        J = {
        ...
        ee = {
            ...
            updateNavigation: function() {
                ...
                if (!e.params.loop && e.navigation) {
                    var t = e.navigation,
                        i = t.$nextEl,
                        s = t.$prevEl;
                    s && s.length > 0 && (e.isBeginning ? (e.a11y.disableEl(s), e.a11y.makeElNotFocusable(s)) : (e.a11y.enableEl(s), e.a11y.makeElFocusable(s))), i && i.length > 0 && (e.isEnd ? (e.a11y.disableEl(i), e.a11y.makeElNotFocusable(i)) : (e.a11y.enableEl(i), e.a11y.makeElFocusable(i)))
                }
            },
            ...
            init: function() {
                ...
                e.a11y.addElId(a, o), e.a11y.addElLive(a, r), t.itemRoleDescriptionMessage && e.a11y.addElRoleDescription(m(e.slides), t.itemRoleDescriptionMessage), e.a11y.addElRole(m(e.slides), t.slideRole), e.slides.each(function(i) {
                    var s = m(i),
                        n = t.slideLabelMessage.replace(/\{\{index\}\}/, s.index() + 1).replace(/\{\{slidesLength\}\}/, e.slides.length);
        ...
        te = {
            ...
            setHistory: function(e, t) {
                ...
                if (i.history.initialized && i.params.history.enabled) {
                    var n;
                    n = i.params.url ? new URL(i.params.url) : s.location;
                    var a = i.slides.eq(t),
                        o = te.slugify(a.attr("data-history"));
                    if (i.params.history.root.length > 0) {
                        var l = i.params.history.root;
                        "/" === l[l.length - 1] && (l = l.slice(0, l.length - 1)), o = l + "/" + e + "/" + o
                    } else n.pathname.includes(e) || (o = e + "/" + o);
                    var d = s.history.state;
                    d && d.value === o || (i.params.history.replaceState ? s.history.replaceState({
                        value: o
            ...
            scrollToSlide: function(e, t, i) {
                ...
                if (t)
                    for (var n = 0, a = s.slides.length; n < a; n += 1) {
                        var o = s.slides.eq(n);
                        if (te.slugify(o.attr("data-history")) === t && !o.hasClass(s.params.slideDuplicateClass)) {
                            var r = o.index();
                            s.slideTo(r, e, i)
                        }
        ...
        ie = {
            onHashCange: function() {
                ...
                if (i !== e.slides.eq(e.activeIndex).attr("data-hash")) {
                    var s = e.$wrapperEl.children("." + e.params.slideClass + '[data-hash="' + i + '"]').index();
                    if (void 0 === s) return;
                    e.slideTo(s)
                }
            },
            setHash: function() {
                ...
                if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
                    if (e.params.hashNavigation.replaceState && t.history && t.history.replaceState) t.history.replaceState(null, null, "#" + e.slides.eq(e.activeIndex).attr("data-hash") || ""), e.emit("hashSet");
                        ...
                        var s = e.slides.eq(e.activeIndex),
                ...
                if (!(!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled)) {
                    ...
                    if (s)
                        for (var n = 0, o = e.slides.length; n < o; n += 1) {
                            var l = e.slides.eq(n);
                            if ((l.attr("data-hash") || l.attr("data-history")) === s && !l.hasClass(e.params.slideDuplicateClass)) {
                                var d = l.index();
        ...
        ae = {
            setTranslate: function() {
                var e, t = this,
                    ...
                    h = 0;
                c.shadow && (p ? (0 === (e = s.find(".swiper-cube-shadow")).length && (e = m('<div class="swiper-cube-shadow"></div>'), s.append(e)), e.css({
                    height: a + "px"
                ...
                for (var f = 0; f < n.length; f += 1) {
                    ...
                    var w = Math.max(Math.min(v[0].progress, 1), -1),
                        ...
                        S = 0,
                        C = 0;
                    g % 4 == 0 ? (x = 4 * -y * l, C = 0) : (g - 1) % 4 == 0 ? (x = 0, C = 4 * -y * l) : (g - 2) % 4 == 0 ? (x = l + 4 * y * l, C = l) : (g - 3) % 4 == 0 && (x = -l, C = 3 * l + 4 * l * y), r && (x = -x), p || (S = x, x = 0);
                    var T = "rotateX(" + (p ? 0 : -b) + "deg) rotateY(" + (p ? b : 0) + "deg) translate3d(" + x + "px, " + S + "px, " + C + "px)";
                    if (w <= 1 && w > -1 && (h = 90 * g + 90 * w, r && (h = 90 * -g - 90 * w)), v.transform(T), c.slideShadows) {
                        var E = p ? v.find(".swiper-slide-shadow-left") : v.find(".swiper-slide-shadow-top"),
                            k = p ? v.find(".swiper-slide-shadow-right") : v.find(".swiper-slide-shadow-bottom");
                        0 === E.length && (E = m('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>'), v.append(E)), 0 === k.length && (k = m('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>'), v.append(k)), E.length && (E[0].style.opacity = Math.max(-w, 0)), k.length && (k[0].style.opacity = Math.max(w, 0))
                    }
                }
                if (s.css({
                    ...
                    if (p) e.transform("translate3d(0px, " + (a / 2 + c.shadowOffset) + "px, " + -a / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + c.shadowScale + ")");
                    else {
                ...
                var A = d.isSafari || d.isWebView ? -l / 2 : 0;
                s.transform("translate3d(0px,0," + A + "px) rotateX(" + (t.isHorizontal() ? 0 : h) + "deg) rotateY(" + (t.isHorizontal() ? -h : 0) + "deg)")
            },
            setTransition: function(e) {
                var t = this,
                    i = t.$el;
            ...
            setTranslate: function() {
                for (var e = this, t = e.slides, i = e.rtlTranslate, s = 0; s < t.length; s += 1) {
                    ...
                    var o = -180 * a,
                        ...
                        d = 0;
                    if (e.isHorizontal() ? i && (o = -o) : (d = l, l = 0, r = -o, o = 0), n[0].style.zIndex = -Math.abs(Math.round(a)) + t.length, e.params.flipEffect.slideShadows) {
                        ...
                        0 === c.length && (c = m('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>'), n.append(c)), 0 === p.length && (p = m('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>'), n.append(p)), c.length && (c[0].style.opacity = Math.max(-a, 0)), p.length && (p[0].style.opacity = Math.max(a, 0))
                    }
        ...
        re = {
            setTranslate: function() {
                for (var e = this, t = e.width, i = e.height, s = e.slides, n = e.slidesSizesGrid, a = e.params.coverflowEffect, o = e.isHorizontal(), r = e.translate, l = o ? t / 2 - r : i / 2 - r, d = o ? a.rotate : -a.rotate, c = a.depth, p = 0, u = s.length; p < u; p += 1) {
                    var h = s.eq(p),
                        f = n[p],
                    ...
                    Math.abs(S) < .001 && (S = 0), Math.abs(x) < .001 && (x = 0), Math.abs(y) < .001 && (y = 0), Math.abs(g) < .001 && (g = 0), Math.abs(b) < .001 && (b = 0), Math.abs(C) < .001 && (C = 0);
                    var T = "translate3d(" + S + "px," + x + "px," + y + "px)  rotateX(" + b + "deg) rotateY(" + g + "deg) scale(" + C + ")";
                    if (h.transform(T), h[0].style.zIndex = 1 - Math.abs(Math.round(v)), a.slideShadows) {
                        var E = o ? h.find(".swiper-slide-shadow-left") : h.find(".swiper-slide-shadow-top"),
                            k = o ? h.find(".swiper-slide-shadow-right") : h.find(".swiper-slide-shadow-bottom");
                        0 === E.length && (E = m('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>'), h.append(E)), 0 === k.length && (k = m('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>'), h.append(k)), E.length && (E[0].style.opacity = v > 0 ? v : 0), k.length && (k[0].style.opacity = -v > 0 ? -v : 0)
                    }
                }
            },
            setTransition: function(e) {
            ...
            onThumbClick: function() {
                ...
                if (t) {
                    var i = t.clickedIndex,
                        s = t.clickedSlide;
                    if (!(s && m(s).hasClass(e.params.thumbs.slideThumbActiveClass) || null == i)) {
                        var n;
                        if (n = t.params.loop ? parseInt(m(t.clickedSlide).attr("data-swiper-slide-index"), 10) : i, e.params.loop) {
                            var a = e.activeIndex;
                ...
                if (i) {
                    ...
                    if (t.realIndex !== i.realIndex || a) {
                        ...
                        if (i.params.loop) {
                            ...
                            o = void 0 === d ? c : void 0 === c ? d : c - l == l - d ? i.params.slidesPerGroup > 1 ? c : l : c - l < l - d ? c : d, r = t.activeIndex > t.previousIndex ? "next" : "prev"
                        } else r = (o = t.realIndex) > t.previousIndex ? "next" : "prev";
                        a && (o += "next" === r ? n : -1 * n), i.visibleSlidesIndexes && i.visibleSlidesIndexes.indexOf(o) < 0 && (i.params.centeredSlides ? o = o > l ? o - Math.floor(s / 2) + 1 : o + Math.floor(s / 2) - 1 : o > l && i.params.slidesPerGroup, i.slideTo(o, e ? 0 : void 0))
                    }
                    var p = 1,
                        u = t.params.thumbs.slideThumbActiveClass;
                    if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (p = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (p = 1), p = Math.floor(p), i.slides.removeClass(u), i.params.loop || i.params.virtual && i.params.virtual.enabled)
                        for (var h = 0; h < p; h += 1) i.$wrapperEl.children('[data-swiper-slide-index="' + (t.realIndex + h) + '"]').addClass(u);
                    else
                        for (var f = 0; f < p; f += 1) i.slides.eq(t.realIndex + f).addClass(u)
                }
            }
        },
        de = [X, W, {
            ...
            on: {
                ...
                click: function(e, t) {
                    var i = e.navigation,
                        ...
                        n = i.$prevEl,
                        a = t.target;
                    if (e.params.navigation.hideOnClick && !m(a).is(n) && !m(a).is(s)) {
                        if (e.pagination && e.params.pagination && e.params.pagination.clickable && (e.pagination.el === a || e.pagination.el.contains(a))) return;
                        var o;
                        s ? o = s.hasClass(e.params.navigation.hiddenClass) : n && (o = n.hasClass(e.params.navigation.hiddenClass)), !0 === o ? e.emit("navigationShow") : e.emit("navigationHide"), s && s.toggleClass(e.params.navigation.hiddenClass), n && n.toggleClass(e.params.navigation.hiddenClass)
                    }
                }
            }
        }, {
            ...
            on: {
                ...
                slideChange: function(e) {
                    var t = e.params,
                        ...
                        r = t.resistanceRatio;
                    i.enabled && (s || (n || a) && (o || 0 === r)) && e.lazy.load()
                }
            }
        }, {
            name: "controller",
...
function(e) {
    ...
    (t = function() {
        ...
        if (s = document.createDocumentFragment(), a = r.$slider.children(), r.options.rows > 1) {
            for (o = r.options.slidesPerRow * r.options.rows, n = Math.ceil(a.length / o), e = 0; e < n; e++) {
        ...
        if ("window" === o.respondTo ? a = d : "slider" === o.respondTo ? a = l : "min" === o.respondTo && (a = Math.min(d, l)), o.options.responsive && o.options.responsive.length && null !== o.options.responsive) {
            for (s in n = null, o.breakpoints) o.breakpoints.hasOwnProperty(s) && (!1 === o.originalSettings.mobileFirst ? a < o.breakpoints[s] && (n = o.breakpoints[s]) : a > o.breakpoints[s] && (n = o.breakpoints[s]));
        ...
        var s, n, a = this,
            o = e(t.currentTarget);
        switch (o.is("a") && t.preventDefault(), o.is("li") || (o = o.closest("li")), s = a.slideCount % a.options.slidesToScroll != 0 ? 0 : (a.slideCount - a.currentSlide) % a.options.slidesToScroll, t.data.message) {
            case "previous":
            ...
            case "index":
                ...
                a.slideHandler(a.checkNavigable(r), !1, i), o.children().trigger("focus");
                break;
            default:
                return
        }
        ...
        var t, i, s, n, a = this,
            o = 0;
        return a.slideOffset = 0, i = a.$slides.first().outerHeight(!0), !0 === a.options.infinite ? (a.slideCount > a.options.slidesToShow && (a.slideOffset = a.slideWidth * a.options.slidesToShow * -1, n = -1, !0 === a.options.vertical && !0 === a.options.centerMode && (2 === a.options.slidesToShow ? n = -1.5 : 1 === a.options.slidesToShow && (n = -2)), o = i * a.options.slidesToShow * n), a.slideCount % a.options.slidesToScroll != 0 && e + a.options.slidesToScroll > a.slideCount && a.slideCount > a.options.slidesToShow && (e > a.slideCount ? (a.slideOffset = (a.options.slidesToShow - (e - a.slideCount)) * a.slideWidth * -1, o = (a.options.slidesToShow - (e - a.slideCount)) * i * -1) : (a.slideOffset = a.slideCount % a.options.slidesToScroll * a.slideWidth * -1, o = a.slideCount % a.options.slidesToScroll * i * -1))) : e + a.options.slidesToShow > a.slideCount && (a.slideOffset = (e + a.options.slidesToShow - a.slideCount) * a.slideWidth, o = (e + a.options.slidesToShow - a.slideCount) * i), a.slideCount <= a.options.slidesToShow && (a.slideOffset = 0, o = 0), !0 === a.options.centerMode && a.slideCount <= a.options.slidesToShow ? a.slideOffset = a.slideWidth * Math.floor(a.options.slidesToShow) / 2 - a.slideWidth * a.slideCount / 2 : !0 === a.options.centerMode && !0 === a.options.infinite ? a.slideOffset += a.slideWidth * Math.floor(a.options.slidesToShow / 2) - a.slideWidth : !0 === a.options.centerMode && (a.slideOffset = 0, a.slideOffset += a.slideWidth * Math.floor(a.options.slidesToShow / 2)), t = !1 === a.options.vertical ? e * a.slideWidth * -1 + a.slideOffset : e * i * -1 + o, !0 === a.options.variableWidth && (s = a.slideCount <= a.options.slidesToShow || !1 === a.options.infinite ? a.$slideTrack.children(".slick-slide").eq(e) : a.$slideTrack.children(".slick-slide").eq(e + a.options.slidesToShow), t = !0 === a.options.rtl ? s[0] ? -1 * (a.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, !0 === a.options.centerMode && (s = a.slideCount <= a.options.slidesToShow || !1 === a.options.infinite ? a.$slideTrack.children(".slick-slide").eq(e) : a.$slideTrack.children(".slick-slide").eq(e + a.options.slidesToShow + 1), t = !0 === a.options.rtl ? s[0] ? -1 * (a.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, t += (a.$list.width() - s.outerWidth()) / 2)), t
        ...
        if ("array" === e.type(a) && a.length) {
            for (t in n.respondTo = n.options.respondTo || "window", a)
        ...
        var t, i, s, n, a, o = this,
            r = !1;
        if ("object" === e.type(arguments[0]) ? (s = arguments[0], r = arguments[1], a = "multiple") : "string" === e.type(arguments[0]) && (s = arguments[0], n = arguments[1], r = arguments[2], "responsive" === arguments[0] && "array" === e.type(arguments[1]) ? a = "responsive" : void 0 !== arguments[1] && (a = "single")), "single" === a) o.options[s] = n;
        ...
        if (i = a.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), a.$slides.eq(e).addClass("slick-current"), !0 === a.options.centerMode) {
            ...
            t = Math.floor(a.options.slidesToShow / 2), !0 === a.options.infinite && (e >= t && e <= a.slideCount - 1 - t ? a.$slides.slice(e - t + o, e + t + 1).addClass("slick-active").attr("aria-hidden", "false") : (s = a.options.slidesToShow + e, i.slice(s - t + 1 + o, s + t + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === e ? i.eq(i.length - 1 - a.options.slidesToShow).addClass("slick-center") : e === a.slideCount - 1 && i.eq(a.options.slidesToShow).addClass("slick-center")), a.$slides.eq(e).addClass("slick-center")
        ...
        if (t = t || !1, !(!0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === e))
            if (!1 === t && d.asNavFor(e), s = e, l = d.getLeft(s), o = d.getLeft(d.currentSlide), d.currentLeft = null === d.swipeLeft ? o : d.swipeLeft, !1 === d.options.infinite && !1 === d.options.centerMode && (e < 0 || e > d.getDotCount() * d.options.slidesToScroll)) !1 === d.options.fade && (s = d.currentSlide, !0 !== i ? d.animateSlide(o, function() {
                d.postSlide(s)
            }) : d.postSlide(s));
            else if (!1 === d.options.infinite && !0 === d.options.centerMode && (e < 0 || e > d.slideCount - d.options.slidesToScroll)) !1 === d.options.fade && (s = d.currentSlide, !0 !== i ? d.animateSlide(o, function() {
            d.postSlide(s)
        }) : d.postSlide(s));
        else {
...
function(e, t) {
    ...
    ! function() {
        ...
        t = i ? {
            ...
            i = i.split(" "), e.event.special[a + t] = {
                setup: function() {
                    var t = this;
                    e.each(i, function(e, i) {
                        t.addEventListener ? t.addEventListener(i, r, !1) : t["on" + i] = r
                    })
                },
                teardown: function() {
                    var t = this;
                    e.each(i, function(e, i) {
                        t.addEventListener ? t.removeEventListener(i, r, !1) : t["on" + i] = null
                    })
                }
            }
        });
        var o = null,
            r = function(t) {
                var i = t || window.event,
                    s = null,
                    r = n[i.type];
                if ((t = e.event.fix(i)).type = a + r, i.pointerType) switch (i.pointerType) {
                    case 2:
                        t.pointerType = "touch";
                        break;
                    case 3:
                ...
                return t.pageX || t.pageY || (s = i.changedTouches ? i.changedTouches[0] : i, t.pageX = s.pageX, t.pageY = s.pageY), "touchend" === i.type && (o = {
                    x: t.pageX,
                    y: t.pageY
                }), "mouse" === t.pointerType && o && function(e) {
                    var t = Math.abs(e.pageX - o.x),
                        i = Math.abs(e.pageY - o.y);
                    return 25 >= t && 25 >= i || void 0
        ...
        e.event.special[i] = {
            setup: function() {
                ...
                e.each(t, function(e, t) {
                    i.addEventListener ? i.addEventListener(t, s, !1) : i["on" + t] = s
                })
            },
            teardown: function() {
                var i = this;
                e.each(t, function(e, t) {
                    i.addEventListener ? i.removeEventListener(t, s, !1) : i["on" + t] = null
                })
            }
        };
        var s = function(t) {
            var s = t || window.event;
            if ((t = e.event.fix(s)).type = i, "detail" in s && (t.deltaY = -s.detail), "wheelDelta" in s && (t.deltaY = -s.wheelDelta), "wheelDeltaY" in s && (t.deltaY = -s.wheelDeltaY), "wheelDeltaX" in s && (t.deltaX = -s.wheelDeltaX), "deltaY" in s && (t.deltaY = s.deltaY), "deltaX" in s && (t.deltaX = s.deltaX), t.delta = t.deltaY || t.deltaX, 1 === s.deltaMode) {
    ...
    var a = {
            fireNativeEvent: function(t, i) {
                e(t).each(function() {
                    var e, t = this;
                    t.dispatchEvent ? ((e = document.createEvent("HTMLEvents")).initEvent(i, !0, !0), t.dispatchEvent(e)) : document.createEventObject && ((e = document.createEventObject()).target = t, t.fireEvent("on" + i, e))
                })
            },
            bindHandlers: function() {
                var t = this;
                e.each(t, function(i, s) {
                    0 === i.indexOf("on") && e.isFunction(s) && (t[i] = function() {
        ...
        o = {
            ...
            setOptions: function(t, s) {
                arguments.length > 1 ? this.modules[t] && e.extend(this.modules[t].prototype.options, s) : e.extend(i, t)
            },
            addModule: function(s) {
                e.isFunction(s) && (s = s(e, window));
                var n = function(s) {
                        s.element.data(i.dataKey) || s.element.data(i.dataKey, this), t.push(this), this.options = e.extend({}, i, this.options, o(s.element), s), this.bindHandlers(), this.init.apply(this, arguments)
                    },
                    o = function(t) {
                        var s = t.data(i.optionsKey),
                            n = t.attr(i.optionsKey);
                        if (s) return s;
                        if (n) try {
                            return e.parseJSON(n)
                        } catch (e) {}
                    };
                n.prototype = s, e.extend(s, a), s.plugins && e.each(s.plugins, function(t, i) {
                    e.extend(i.prototype, a)
                });
            ...
            getInstance: function(t) {
                return e(t).data(i.dataKey)
            },
            replace: function(t, s, n) {
                var a, r = this;
                return i.styleSheetCreated || function() {
                    var t = e("<style>").appendTo("head"),
                        s = t.prop("sheet") || t.prop("styleSheet"),
                        n = function(e, t, i) {
                            i = i || 0, s.insertRule ? s.insertRule(e + "{" + t + "}", i) : s.addRule(e, t, i)
                        };
                    ...
                    var a = e("html"),
                        r = e("body");
                    "rtl" !== a.css("direction") && "rtl" !== r.css("direction") || a.addClass(i.rtlClass), a.on("reset", function() {
                        setTimeout(function() {
                            o.refreshAll()
                        }, 0)
                    ...
                    var t, o = e(this);
                    (a = o.data(i.dataKey)) ? a.refresh(): (s || e.each(r.modules, function(e, t) {
                        return t.prototype.matchElement.call(t.prototype, o) ? (s = e, !1) : void 0
                    }), s && (t = e.extend({
                        element: o
                    }, n), a = new r.modules[s](t)))
                }), a
            },
            refresh: function(t) {
                e(t).each(function() {
                    var t = e(this).data(i.dataKey);
                    t && t.refresh()
                })
            },
            destroy: function(t) {
            ...
            replaceAll: function(t) {
                var i = this;
                e.each(this.modules, function(s, n) {
            ...
            refreshAll: function(s) {
                if (s) e.each(this.modules, function(t, n) {
                    e(n.prototype.selector, s).each(function() {
                        var t = e(this).data(i.dataKey);
                        t && t.refresh()
                    })
                });
                else
                    for (var n = t.length - 1; n >= 0; n--) t[n].refresh()
            },
            destroyAll: function(s) {
                if (s) e.each(this.modules, function(t, n) {
                    e(n.prototype.selector, s).each(function(t, s) {
                        var n = e(s).data(i.dataKey);
                        n && n.destroy()
                    })
                });
                else
...
function(e) {
    e.addModule(function(t, i) {
        ...
        var o = {
            ...
            createInstance: function() {
                this.instance && this.instance.destroy(), this.isListBox() && !this.options.multipleCompactStyle ? this.instance = new n(this.options) : this.instance = new s(this.options)
            },
            refresh: function() {
                this.isListBox() && this.instance instanceof s || !this.isListBox() && this.instance instanceof n ? this.createInstance() : this.instance.refresh()
            },
            destroy: function() {
        ...
        t.extend(s.prototype, {
            ...
            repositionDropdown: function() {
                var e, t, i, s = this.fakeElement.offset(),
                    n = this.fakeElement[0].getBoundingClientRect(),
                    a = n.width || n.right - n.left,
                    o = this.fakeElement.outerHeight(),
                    r = this.dropdown.css("width", a).outerHeight(),
                    l = this.win.scrollTop(),
                    d = this.win.height(),
                    c = !1;
                s.top + o + r > l + d && s.top - r > l && (c = !0), this.options.fakeDropInBody && (i = "static" !== this.fakeDropTarget.css("position") ? this.fakeDropTarget.offset().top : 0, this.options.flipDropToFit && c ? (t = s.left, e = s.top - r - i) : (t = s.left, e = s.top + o - i), this.dropdown.css({
                    width: a,
                    left: t,
                    top: e
            ...
            initStructure: function() {
                this.realElement = t(this.options.element), this.fakeElement = t(this.options.fakeStructure).insertAfter(this.realElement), this.listHolder = this.fakeElement.find(this.options.listHolder), l(this.fakeElement), this.fakeElement.addClass(r(this.realElement.prop("className"), this.options.selectClassPrefix)), this.realElement.addClass(this.options.hiddenClass), this.list = new a({
                    useCustomScroll: this.options.useCustomScroll,
            ...
            onSelectItem: function(e) {
                ...
                this.listHolder.off("click", this.indexSelector, this.onSelectItem), e.button > 1 || this.realOptions[s].disabled || (this.element.prop("multiple") ? e.metaKey || e.ctrlKey || "touch" === n || this.options.multipleSelectWithoutKey ? this.realOptions[s].selected = !this.realOptions[s].selected : e.shiftKey ? (i = [this.lastClickedIndex, s].sort(function(e, t) {
                    return e - t
            ...
            rebuildList: function() {
                ...
                return this.container.toggleClass(this.options.scrollClass, o), o && (this.listHolder.css({
                    ...
                    (0 >= t && e.deltaY < 0 || t >= s && e.deltaY > 0) && e.preventDefault()
            ...
            refreshSelectedClass: function() {
                ...
                }) : (this.fakeOptions.removeClass(this.options.selectedClass + " " + this.options.hoverClass), e = this.fakeOptions.eq(s).addClass(this.options.selectedClass), this.options.useHoverClass && e.addClass(this.options.hoverClass))
            },
            ...
            getSelectedOptionsIndexes: function() {
                var e = [];
                return this.realOptions.each(function(t, i) {
                    i.selected && e.push(t)
                }), e
            },
            getChangedSelectedIndex: function() {
                ...
                return this.element.prop("multiple") ? (this.currentSelection = this.getSelectedOptionsIndexes(), t.each(this.currentSelection, function(e, t) {
                    !s && i.previousSelection.indexOf(t) < 0 && (0 === e && (s = !0), n = t)
                }), this.previousSelection = this.currentSelection, n) : e
            },
            getActiveOptionOffset: function() {
                ...
                if (null !== e) {
                    var t = this.listHolder.height(),
                        ...
                        s = this.fakeOptions.eq(e),
                        n = s.offset().top - this.list.offset().top,
                        a = s.innerHeight();
                    return n + a >= i + t ? n - t + a : i > n ? n : void 0
                }
            },
            ...
            createOption: function(e) {
                ...
                return s && ((i = document.createElement("img")).src = s, t.insertBefore(i, t.childNodes[0])), e.disabled && (t.className += " " + this.options.disabledClass), e.className && (t.className += " " + r(e.className, this.options.cloneClassPrefix)), t
            },
            createOptGroup: function(e) {
                var t, i, s = document.createElement("span"),
                    n = e.getAttribute("label");
                return (t = document.createElement("span")).className = this.options.captionClass, t.innerHTML = n, s.appendChild(t), e.children.length && (i = this.createOptionsList(e), s.appendChild(i)), s.className = this.options.groupClass, s
            },
            ...
            createOptionsList: function(e) {
                ...
                return t.each(e.children, function(e, t) {
                    var n, a = i.createOptionContainer(t);
                    switch (t.tagName.toLowerCase()) {
                        case "option":
                            n = i.createOption(t);
                            break;
                        case "optgroup":
                            n = i.createOptGroup(t)
                    }
                    s.appendChild(a).appendChild(n)
                }), s
            },
            refresh: function() {
        ...
        var r = function(e, t) {
            ...
            l = function() {
                ...
                var i = e.getOptions().unselectableClass;
                return function(e) {
                    e.addClass(i).on("selectstart", t)
                }
            }();
        return o
    })
}(jcf), jcf.addModule(function(e) {
        "use strict";
        return {
            name: "Number",
            ...
            step: function(e) {
                var t = parseFloat(this.realElement.val()),
                    i = t || 0,
                    s = this.stepValue * (e ? 1 : -1),
                    n = isFinite(this.minValue) ? this.minValue : this.initialValue - Math.abs(i * this.stepValue),
                    a = Math.abs(n - i) % this.stepValue;
                a ? e ? i += s - a : i -= a : i += s, i < this.minValue ? i = this.minValue : i > this.maxValue && (i = this.maxValue), i !== t && (this.realElement.val(i).trigger("change"), this.refresh())
            },
            refresh: function() {
    ...
    function(e, t, i, s) {
            ...
            if (i.fn.fancybox) console.info("fancyBox already initialized");
                ...
                var n, a, o = {
                    ...
                    m = function(e, t, s) {
                        this.opts = f({
                            index: s
                        }, i.fancybox.defaults), i.isPlainObject(t) && (this.opts = f(this.opts, t)), i.fancybox.isMobile && (this.opts = f(this.opts, this.opts.mobile)), this.id = this.opts.id || ++d, this.currIndex = parseInt(this.opts.index, 10) || 0, this.prevIndex = null, this.prevPos = null, this.currPos = 0, this.firstRun = !0, this.group = [], this.slides = {}, this.addContent(e), this.group.length && this.init()
                    };
                i.extend(m.prototype, {
                    init: function() {
                        ...
                        o.closeExisting && i.fancybox.close(!0), i("body").addClass("fancybox-active"), !i.fancybox.getInstance() && !1 !== o.hideScrollbar && !i.fancybox.isMobile && t.body.scrollHeight > e.innerHeight && (i("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' + (e.innerWidth - t.documentElement.clientWidth) + "px;}</style>"), i("body").addClass("compensate-for-scrollbar")), n = "", i.each(o.buttons, function(e, t) {
                            n += o.btnTpl[t] || ""
                        }), s = i(a.translate(a, o.baseTpl.replace("{{buttons}}", n).replace("{{arrows}}", o.btnTpl.arrowLeft + o.btnTpl.arrowRight))).attr("id", "fancybox-container-" + a.id).addClass(o.baseClass).data("FancyBox", a).appendTo(o.parentEl), a.$refs = {
                            container: s
                    ...
                    addContent: function(e) {
                        ...
                        i.each(n, function(e, t) {
                            var n, a, o, r, l, d = {},
                                c = {};
                            i.isPlainObject(t) ? (d = t, c = t.opts || t) : "object" === i.type(t) && i(t).length ? (c = (n = i(t)).data() || {}, (c = i.extend(!0, {}, c, c.options)).$orig = n, d.src = s.opts.src || c.src || n.attr("href"), d.type || d.src || (d.type = "inline", d.src = t)) : d = {
                                type: "html",
                                src: t + ""
                            ...
                            })) : "#" === r.charAt(0) && (a = "inline")), a ? d.type = a : s.trigger("objectNeedsType", d), d.contentType || (d.contentType = i.inArray(d.type, ["html", "inline", "ajax"]) > -1 ? "html" : d.type), d.index = s.group.length, "auto" == d.opts.smallBtn && (d.opts.smallBtn = i.inArray(d.type, ["html", "inline", "ajax"]) > -1), "auto" === d.opts.toolbar && (d.opts.toolbar = !d.opts.smallBtn), d.$thumb = d.opts.$thumb || null, d.opts.$trigger && d.index === s.opts.index && (d.$thumb = d.opts.$trigger.find("img:first"), d.$thumb.length && (d.opts.$orig = d.opts.$trigger)), d.$thumb && d.$thumb.length || !d.opts.$orig || (d.$thumb = d.opts.$orig.find("img:first")), d.$thumb && !d.$thumb.length && (d.$thumb = null), d.thumb = d.opts.thumb || (d.$thumb ? d.$thumb[0].src : null), "function" === i.type(d.opts.caption) && (d.opts.caption = d.opts.caption.apply(t, [s, d])), "function" === i.type(s.opts.caption) && (d.opts.caption = s.opts.caption.apply(t, [s, d])), d.opts.caption instanceof i || (d.opts.caption = void 0 === d.opts.caption ? "" : d.opts.caption + ""), "ajax" === d.type && (l = r.split(/\s+/, 2)).length > 1 && (d.src = l.shift(), d.opts.filter = l.shift()), d.opts.modal && (d.opts = i.extend(!0, d.opts, {
                                trapFocus: !0,
                                infobar: 0,
                                toolbar: 0,
                                smallBtn: 0,
                    ...
                    addEvents: function() {
                        ...
                        t.removeEvents(), t.$refs.container.on("click.fb-close", "[data-fancybox-close]", function(e) {
                            ...
                            e && e.originalEvent && "resize" === e.originalEvent.type ? (t.requestId && p(t.requestId), t.requestId = c(function() {
                                t.update(e)
                            ...
                            var s = (i.fancybox ? i.fancybox.getInstance() : null).current,
                                n = e.keyCode || e.which;
                            if (9 != n) {
                                if (!(!s.opts.keyboard || e.ctrlKey || e.altKey || e.shiftKey || i(e.target).is("input,textarea,video,audio,select"))) return 8 === n || 27 === n ? (e.preventDefault(), void t.close(e)) : 37 === n || 38 === n ? (e.preventDefault(), void t.previous()) : 39 === n || 40 === n ? (e.preventDefault(), void t.next()) : void t.trigger("afterKeydown", e, n)
                        ...
                        if (!(u.isDragging || u.isClosing || u.isAnimating && u.firstRun)) {
                            ...
                            l = i.fancybox.getTranslate(r.$slide), d = i.fancybox.getTranslate(u.$refs.stage), i.each(u.slides, function(e, t) {
                                ...
                                i.fancybox.setTranslate(s.$slide, {
                                    top: 0,
                                    left: n - d.left + p
                                }), s.pos !== o.pos && s.$slide.addClass("fancybox-slide--" + (s.pos > o.pos ? "next" : "previous")), h(s.$slide), i.fancybox.animate(s.$slide, {
                                    top: 0,
                    ...
                    createSlide: function(e) {
                        var t, s;
                        return s = (s = e % this.group.length) < 0 ? this.group.length + s : s, !this.slides[e] && this.group[s] && (t = i('<div class="fancybox-slide"></div>').appendTo(this.$refs.stage), this.slides[e] = i.extend(!0, {}, this.group[s], {
                            pos: e,
                            $slide: t,
                            isLoaded: !1
                    ...
                    scaleToActual: function(e, t, s) {
                        var n, a, o, r, l, d = this,
                            c = d.current,
                            p = c.$content,
                            u = i.fancybox.getTranslate(c.$slide).width,
                            h = i.fancybox.getTranslate(c.$slide).height,
                            f = c.width,
                            m = c.height;
                        d.isAnimating || d.isMoved() || !p || "image" != c.type || !c.isLoaded || c.hasError || (d.isAnimating = !0, i.fancybox.stop(p), e = void 0 === e ? .5 * u : e, t = void 0 === t ? .5 * h : t, (n = i.fancybox.getTranslate(p)).top -= i.fancybox.getTranslate(c.$slide).top, n.left -= i.fancybox.getTranslate(c.$slide).left, r = f / n.width, l = m / n.height, a = .5 * u - .5 * f, o = .5 * h - .5 * m, f > u && ((a = n.left * r - (e * r - e)) > 0 && (a = 0), a < u - f && (a = u - f)), m > h && ((o = n.top * l - (t * l - t)) > 0 && (o = 0), o < h - m && (o = h - m)), d.updateCursor(f, m), i.fancybox.animate(p, {
                            top: o,
                            left: a,
                            scaleX: r,
                            scaleY: l
                    ...
                    checkSrcset: function(t) {
                        var i, s, n, a, o = t.opts.srcset || t.opts.image.srcset;
                        if (o) {
                            n = e.devicePixelRatio || 1, a = e.innerWidth * n, (s = o.split(",").map(function(e) {
                                var t = {};
                        ...
                        e.$content = i('<div class="fancybox-content' + (n.preload ? " fancybox-is-hidden" : "") + '"></div>').css(n.css).appendTo(a), a.addClass("fancybox-slide--" + e.contentType), e.$iframe = t = i(n.tpl.replace(/\{rnd\}/g, (new Date).getTime())).attr(n.attr).appendTo(e.$content), n.preload ? (s.showLoading(e), t.on("load.fb error.fb", function(t) {
                            ...
                            if (1 === t[0].isReady) {
                                ...
                                i && i.length && i.children().length && (a.css("overflow", "visible"), s.css({
                                    ...
                                    "max-width": "100%",
                                    height: "9999px"
                                }), void 0 === o && (o = Math.ceil(Math.max(i[0].clientWidth, i.outerWidth(!0)))), s.css("width", o || "").css("max-width", ""), void 0 === r && (r = Math.ceil(Math.max(i[0].clientHeight, i.outerHeight(!0)))), s.css("height", r || ""), a.css("overflow", "auto")), s.removeClass("fancybox-is-hidden")
                            }
                    ...
                    adjustCaption: function(e) {
                        var t, i = e || this.current,
                            ...
                            a = this.$refs.caption,
                            o = !1;
                        a.toggleClass("fancybox-caption--separate", n), n && s && s.length && (i.pos !== this.currPos ? ((t = a.clone().appendTo(a.parent())).children().eq(0).empty().html(s), o = t.outerHeight(!0), t.empty().remove()) : this.$caption && (o = this.$caption.outerHeight(!0)), i.$slide.css("padding-bottom", o || ""))
                    },
                    ...
                    revealContent: function(e) {
                        var t, s, n, a, o = this,
                            ...
                            c = o.isMoved(e),
                            p = e.isRevealed;
                        return e.isRevealed = !0, t = e.opts[o.firstRun ? "animationEffect" : "transitionEffect"], n = e.opts[o.firstRun ? "animationDuration" : "transitionDuration"], n = parseInt(void 0 === e.forcedDuration ? n : e.forcedDuration, 10), !c && e.pos === o.currPos && n || (t = !1), "zoom" === t && (e.pos === o.currPos && n && "image" === e.type && !e.hasError && (d = o.getThumbPos(e)) ? l = o.getFitPos(e) : t = "fade"), "zoom" === t ? (o.isAnimating = !0, l.scaleX = l.width / d.width, l.scaleY = l.height / d.height, "auto" == (a = e.opts.zoomOpacity) && (a = Math.abs(e.width / e.height - d.width / d.height) > .1), a && (d.opacity = .1, l.opacity = 1), i.fancybox.setTranslate(e.$content.removeClass("fancybox-is-hidden"), d), h(e.$content), void i.fancybox.animate(e.$content, l, n, function() {
                            o.isAnimating = !1, o.complete()
                        })) : (o.updateSlide(e), t ? (i.fancybox.stop(r), s = "fancybox-slide--" + (e.pos >= o.prevPos ? "next" : "previous") + " fancybox-animated fancybox-fx-" + t, r.addClass(s).removeClass("fancybox-slide--current"), e.$content.removeClass("fancybox-is-hidden"), h(r), "image" !== e.type && e.$content.hide().show(0), void i.fancybox.animate(r, "fancybox-slide--current", n, function() {
                            r.removeClass(s).css({
                                transform: "",
                                opacity: ""
                            }), e.pos === o.currPos && o.complete()
                        }, !0)) : (e.$content.removeClass("fancybox-is-hidden"), p || !c || "image" !== e.type || e.hasError || e.$content.hide().fadeIn("fast"), void(e.pos === o.currPos && o.complete())))
                    },
                    getThumbPos: function(e) {
                        var s, n, a, o, r, l, d = e.$thumb;
                        return !(!d || ! function(e) {
                            var s, n;
                        ...
                        }(d[0])) && (n = i.fancybox.getTranslate(d), a = parseFloat(d.css("border-top-width") || 0), o = parseFloat(d.css("border-right-width") || 0), r = parseFloat(d.css("border-bottom-width") || 0), l = parseFloat(d.css("border-left-width") || 0), s = {
                            top: n.top + a,
                            left: n.left + l,
                            width: n.width - o - l,
                            height: n.height - a - r,
                    ...
                    complete: function() {
                        var e, t = this,
                            s = t.current,
                            n = {};
                        !t.isMoved() && s.isLoaded && (s.isComplete || (s.isComplete = !0, s.$slide.siblings().trigger("onReset"), t.preload("inline"), h(s.$slide), s.$slide.addClass("fancybox-slide--complete"), i.each(t.slides, function(e, s) {
                    ...
                    focus: function(e, s) {
                        var n, a, o = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden])", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"])'].join(",");
                        this.isClosing || ((n = (n = !e && this.current && this.current.isComplete ? this.current.$slide.find("*:visible" + (s ? ":not(.fancybox-close-small)" : "")) : this.$refs.container.find("*:visible")).filter(o).filter(function() {
                            return "hidden" !== i(this).css("visibility") && !i(this).hasClass("disabled")
                        })).length ? (a = n.index(t.activeElement), e && e.shiftKey ? (a < 0 || 0 == a) && (e.preventDefault(), n.eq(n.length - 1).trigger("focus")) : (a < 0 || a == n.length - 1) && (e && e.preventDefault(), n.eq(0).trigger("focus"))) : this.$refs.container.trigger("focus"))
                    },
                    activate: function() {
                        var e = this;
                    ...
                    close: function(e, t) {
                        ...
                        return !p.isClosing && (p.isClosing = !0, !1 === p.trigger("beforeClose", e) ? (p.isClosing = !1, c(function() {
                            p.update()
                        }), !1) : (p.removeEvents(), a = u.$content, s = u.opts.animationEffect, n = i.isNumeric(t) ? t : s ? u.opts.animationDuration : 0, u.$slide.removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"), !0 !== e ? i.fancybox.stop(u.$slide) : s = !1, u.$slide.siblings().trigger("onReset").remove(), n && p.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing").css("transition-duration", n + "ms"), p.hideLoading(u), p.hideControls(!0), p.updateCursor(), "zoom" !== s || a && n && "image" === u.type && !p.isMoved() && !u.hasError && (d = p.getThumbPos(u)) || (s = "fade"), "zoom" === s ? (i.fancybox.stop(a), l = {
                            ...
                            width: d.width,
                            height: d.height
                        }, "auto" == (r = u.opts.zoomOpacity) && (r = Math.abs(u.width / u.height - d.width / d.height) > .1), r && (d.opacity = 0), i.fancybox.setTranslate(a, l), h(a), i.fancybox.animate(a, d, n, f), !0) : (s && n ? i.fancybox.animate(u.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + s, n, f) : !0 === e ? setTimeout(f, n) : f(), !0)))
                    },
                    cleanUp: function(t) {
                        var s, n, a, o = this.current.opts.$orig;
                    ...
                    trigger: function(e, t) {
                        ...
                        if (a ? n.unshift(a) : a = this, n.unshift(this), i.isFunction(a.opts[e]) && (s = a.opts[e].apply(a, n)), !1 === s) return s;
                        "afterClose" !== e && this.$refs ? this.$refs.container.trigger(e + ".fb", n) : l.trigger(e + ".fb", n)
                    },
                    updateControls: function() {
                        var e = this.current,
                            ...
                            a = this.$refs.caption,
                            o = e.opts.caption;
                        e.$slide.trigger("refresh"), o && o.length ? (this.$caption = a, a.children().eq(0).html(o)) : this.$caption = null, this.hasHiddenControls || this.isIdle || this.showControls(), n.find("[data-fancybox-count]").html(this.group.length), n.find("[data-fancybox-index]").html(s + 1), n.find("[data-fancybox-prev]").prop("disabled", !e.opts.loop && s <= 0), n.find("[data-fancybox-next]").prop("disabled", !e.opts.loop && s >= this.group.length - 1), "image" === e.type ? n.find("[data-fancybox-zoom]").show().end().find("[data-fancybox-download]").attr("href", e.opts.image.src || e.src).show() : e.opts.toolbar && n.find("[data-fancybox-download],[data-fancybox-zoom]").hide(), i(t.activeElement).is(":hidden,[disabled]") && this.$refs.container.trigger("focus")
                    },
                    ...
                    animate: function(e, t, s, n, a) {
                        var o, r = this;
                        i.isFunction(s) && (n = s, s = null), r.stop(e), o = r.getTranslate(e), e.on(u, function(l) {
        ...
        function v(e, t) {
            var s, n, a, o = [],
                r = 0;
            e && e.isDefaultPrevented() || (e.preventDefault(), t = t || {}, e && e.data && (t = f(e.data.options, t)), s = t.$target || i(e.currentTarget).trigger("blur"), (a = i.fancybox.getInstance()) && a.$trigger && a.$trigger.is(s) || (o = t.selector ? i(t.selector) : (n = s.attr("data-fancybox") || "") ? (o = e.data ? e.data.items : []).length ? o.filter('[data-fancybox="' + n + '"]') : i('[data-fancybox="' + n + '"]') : [s], (r = i(o).index(s)) < 0 && (r = 0), (a = i.fancybox.open(o, t, r)).$trigger = s))
        }
    ...
    function(e) {
        ...
        e(document).on("objectNeedsType.fb", function(s, n, a) {
            var o, r, l, d, c, p, u, h = a.src || "",
                f = !1;
            o = e.extend(!0, {}, t, a.opts.media), e.each(o, function(t, s) {
                if (l = h.match(s.matcher)) {
                    if (f = s.type, u = t, p = {}, s.paramPlace && l[s.paramPlace]) {
                    ...
                    return d = e.extend(!0, {}, s.params, a.opts[t], p), h = "function" === e.type(s.url) ? s.url.call(this, l, d, a) : i(s.url, l, d), r = "function" === e.type(s.thumb) ? s.thumb.call(this, l, d, a) : i(s.thumb, l), "youtube" === t ? h = h.replace(/&t=((\d+)m)?(\d+)s/, function(e, t, i, s) {
                        return "&start=" + ((i ? 60 * parseInt(i, 10) : 0) + parseInt(s, 10))
                    }) : "vimeo" === t && (h = h.replace("&%23", "#")), !1
                }
            }), f ? (a.opts.thumb || a.opts.$thumb && a.opts.$thumb.length || (a.opts.thumb = r), "iframe" === f && (a.opts = e.extend(!0, a.opts, {
                iframe: {
                    preload: !1,
                    attr: {
                        scrolling: "no"
    ...
    function(e, t, i) {
        ...
        var s = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || function(t) {
            ...
            l = function(t) {
                for (var i, s, n, a, o, r = !1; i = t.get(0), s = void 0, n = void 0, a = void 0, o = void 0, s = e.getComputedStyle(i)["overflow-y"], n = e.getComputedStyle(i)["overflow-x"], a = ("scroll" === s || "auto" === s) && i.scrollHeight > i.clientHeight, o = ("scroll" === n || "auto" === n) && i.scrollWidth > i.clientWidth, !(r = a || o) && (t = t.parent()).length && !t.hasClass("fancybox-stage") && !t.is("body"););
                return r
            },
            d = function(e) {
        ...
        d.prototype.destroy = function() {
            this.$container.off(".fb.touch"), i(t).off(".fb.touch"), this.requestId && (n(this.requestId), this.requestId = null), this.tapped && (clearTimeout(this.tapped), this.tapped = null)
            ...
            if (!0 !== l) "x" == l && (o.distanceX > 0 && (o.instance.group.length < 2 || 0 === o.instance.current.index && !o.instance.current.opts.loop) ? d += Math.pow(o.distanceX, .8) : o.distanceX < 0 && (o.instance.group.length < 2 || o.instance.current.index === o.instance.group.length - 1 && !o.instance.current.opts.loop) ? d -= Math.pow(-o.distanceX, .8) : d += o.distanceX), o.sliderLastPos = {
                ...
                if (o.canTap = !1, r.group.length < 2 && o.opts.vertical ? o.isSwiping = "y" : r.isDragging || !1 === o.opts.vertical || "auto" === o.opts.vertical && i(e).width() > 800 ? o.isSwiping = "x" : (a = Math.abs(180 * Math.atan2(o.distanceY, o.distanceX) / Math.PI), o.isSwiping = a > 45 && a < 135 ? "y" : "x"), "y" === o.isSwiping && i.fancybox.isMobile && o.isScrollable) return void(o.isScrolling = !0);
                r.isDragging = o.isSwiping, o.startPoints = o.newPoints, i.each(r.slides, function(e, t) {
                    var s, n;
                    i.fancybox.stop(t.$slide), s = i.fancybox.getTranslate(t.$slide), n = i.fancybox.getTranslate(r.$refs.stage), t.$slide.css({
                        transform: "",
                        opacity: "",
                        "transition-duration": ""
                    }).removeClass("fancybox-animated").removeClass(function(e, t) {
                        return (t.match(/(^|\s)fancybox-fx-\S+/g) || []).join(" ")
                    }), t.pos === r.current.pos && (o.sliderStartPos.top = s.top - n.top, o.sliderStartPos.left = s.left - n.left), i.fancybox.setTranslate(t.$slide, {
                        top: s.top - n.top,
                        left: s.left - n.left
                    })
            ...
            var e = this;
            o(e.newPoints[0], e.realPoints[0]) < (i.fancybox.isMobile ? 10 : 5) ? e.startPoints = e.newPoints : (e.canTap = !1, e.contentLastPos = e.limitMovement(), e.requestId && n(e.requestId), e.requestId = s(function() {
                i.fancybox.setTranslate(e.$content, e.contentLastPos)
            }))
        }, d.prototype.limitMovement = function() {
            var e, t, i, s, n, a, o = this.canvasWidth,
                r = this.canvasHeight,
                l = this.distanceX,
                d = this.distanceY,
                ...
                h = c.width,
                f = c.height;
            return n = h > o ? p + l : p, a = u + d, e = Math.max(0, .5 * o - .5 * h), t = Math.max(0, .5 * r - .5 * f), i = Math.min(o - h, .5 * o - .5 * h), s = Math.min(r - f, .5 * r - .5 * f), l > 0 && n > e && (n = e - 1 + Math.pow(-e + p + l, .8) || 0), l < 0 && n < i && (n = i + 1 - Math.pow(i - p - l, .8) || 0), d > 0 && a > t && (a = t - 1 + Math.pow(-t + u + d, .8) || 0), d < 0 && a < s && (a = s + 1 - Math.pow(s - u - d, .8) || 0), {
                top: a,
                left: n
            }
            ...
            var n = this.canvasWidth,
                a = this.canvasHeight;
            return e = i > n ? (e = e > 0 ? 0 : e) < n - i ? n - i : e : Math.max(0, n / 2 - i / 2), {
                top: t = s > a ? (t = t > 0 ? 0 : t) < a - s ? a - s : t : Math.max(0, a / 2 - s / 2),
                left: e
            }
            ...
            var t = this,
                ...
                d = a.left,
                c = a.top,
                p = o(t.newPoints[0], t.newPoints[1]) / t.startDistanceBetweenFingers,
                u = Math.floor(r * p),
                h = Math.floor(l * p),
            ...
            t.canTap = !1, t.newWidth = u, t.newHeight = h, t.contentLastPos = y, t.requestId && n(t.requestId), t.requestId = s(function() {
            ...
            this.speed = 100, this.velocityX = this.distanceX / this.dMs * .5, this.velocityY = this.distanceY / this.dMs * .5, o ? this.endPanning() : r ? this.endZooming() : this.endSwiping(s, l)
        }, d.prototype.endSwiping = function(e, t) {
            var s = !1,
                n = this.instance.group.length,
                a = Math.abs(this.distanceX),
                o = "x" == e && n > 1 && (this.dMs > 130 && a > 10 || a > 50);
            this.sliderLastPos = null, "y" == e && !t && Math.abs(this.distanceY) > 50 ? (i.fancybox.animate(this.instance.current.$slide, {
                top: this.sliderStartPos.top + this.distanceY + 150 * this.velocityY,
                opacity: 0
            }, 200), s = this.instance.close(!0, 250)) : o && this.distanceX > 0 ? s = this.instance.previous(300) : o && this.distanceX < 0 && (s = this.instance.next(300)), !1 !== s || "x" != e && "y" != e || this.instance.centerSlide(200), this.$container.removeClass("fancybox-is-sliding")
        }, d.prototype.endPanning = function() {
            var e, t, s;
            this.contentLastPos && (!1 === this.opts.momentum || this.dMs > 350 ? (e = this.contentLastPos.left, t = this.contentLastPos.top) : (e = this.contentLastPos.left + 500 * this.velocityX, t = this.contentLastPos.top + 500 * this.velocityY), (s = this.limitPosition(e, t, this.contentStartPos.width, this.contentStartPos.height)).width = this.contentStartPos.width, s.height = this.contentStartPos.height, i.fancybox.animate(this.$content, s, 366))
        }, d.prototype.endZooming = function() {
            var e, t, s, n, a = this.instance.current,
                o = this.newWidth,
                r = this.newHeight;
            this.contentLastPos && (e = this.contentLastPos.left, n = {
                ...
                scaleX: 1,
                scaleY: 1
            }, i.fancybox.setTranslate(this.$content, n), o < this.canvasWidth && r < this.canvasHeight ? this.instance.scaleToFit(150) : o > a.width || r > a.height ? this.instance.scaleToActual(this.centerPointStartX, this.centerPointStartY, 150) : (s = this.limitPosition(e, t, o, r), i.fancybox.animate(this.$content, s, 150)))
        }, d.prototype.onTap = function(t) {
            var s, n = this,
                o = i(t.target),
                r = n.instance,
                l = r.current,
                d = t && a(t) || n.startPoints,
                c = d[0] ? d[0].x - i(e).scrollLeft() - n.stagePos.left : 0,
                p = d[0] ? d[0].y - i(e).scrollTop() - n.stagePos.top : 0,
                u = function(e) {
                    var s = l.opts[e];
                    if (i.isFunction(s) && (s = s.apply(r, [l, t])), s) switch (s) {
                        ...
                        case "nextOrClose":
                            ...
                            break;
                        case "zoom":
                            "image" == l.type && (l.isLoaded || l.$ghost) && (r.canPan() ? r.scaleToFit() : r.isScaledDown() ? r.scaleToActual(c, p) : r.group.length < 2 && r.close(n.startEvent))
                    }
                };
            if ((!t.originalEvent || 2 != t.originalEvent.button) && (o.is("img") || !(c > o[0].clientWidth + o.offset().left))) {
                ...
                if (n.tapped) {
                    if (clearTimeout(n.tapped), n.tapped = null, Math.abs(c - n.tapX) > 50 || Math.abs(p - n.tapY) > 50) return this;
                    u("dblclick" + s)
                } else n.tapX = c, n.tapY = p, l.opts["dblclick" + s] && l.opts["dblclick" + s] !== l.opts["click" + s] ? n.tapped = setTimeout(function() {
    ...
    function(e, t) {
        ...
        t.extend(i.prototype, {
            ...
            set: function(e) {
                var i = this.instance,
                    s = i.current;
                s && (!0 === e || s.opts.loop || i.currIndex < i.group.length - 1) ? this.isActive && "video" !== s.contentType && (this.$progress && t.fancybox.animate(this.$progress.show(), {
                    scaleX: 1
            ...
            "afterKeydown.fb": function(i, s, n, a, o) {
                var r = s && s.SlideShow;
                !r || !n.opts.slideShow || 80 !== o && 32 !== o || t(e.activeElement).is("button,a,input") || (a.preventDefault(), r.toggle())
            },
        ...
        t.extend(s.prototype, {
            ...
            create: function() {
                var e, s = this.instance,
                    ...
                    a = [];
                this.$grid || (this.$grid = t('<div class="' + i + " " + i + "-" + this.opts.axis + '"></div>').appendTo(s.$refs.container.find(n).addBack().filter(n)), this.$grid.on("click", "a", function() {
                    s.jumpTo(t(this).attr("data-index"))
                })), this.$list || (this.$list = t('<div class="' + i + '__list">').appendTo(this.$grid)), t.each(s.group, function(t, i) {
                ...
                }), this.$list[0].innerHTML = a.join(""), "x" === this.opts.axis && this.$list.width(parseInt(this.$grid.css("padding-right"), 10) + s.group.length * this.$list.children().eq(0).outerWidth(!0))
            },
            focus: function(e) {
                var t, i, s = this.$list,
                    n = this.$grid;
                this.instance.current && (i = (t = s.children().removeClass("fancybox-thumbs-active").filter('[data-index="' + this.instance.current.index + '"]').addClass("fancybox-thumbs-active")).position(), "y" === this.opts.axis && (i.top < 0 || i.top > s.height() - t.outerHeight()) ? s.stop().animate({
                    scrollTop: s.scrollTop() + i.top
                }, e) : "x" === this.opts.axis && (i.left < n.scrollLeft() || i.left > n.scrollLeft() + (n.width() - t.outerWidth())) && s.parent().stop().animate({
                    scrollLeft: i.left
                }, e))
            },
            update: function() {
    ...
    function(e, t) {
        ...
        t.extend(!0, t.fancybox.defaults, {
            ...
            var e, i, s, n, a = t.fancybox.getInstance(),
                o = a.current || null;
            o && ("function" === t.type(o.opts.share.url) && (e = o.opts.share.url.apply(o, [a, o])), i = o.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === o.type ? encodeURIComponent(o.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(e)).replace(/\{\{url_raw\}\}/g, (s = e, n = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
                '"': "&quot;",
        ...
        i.escapeSelector || (i.escapeSelector = function(e) {
            ...
            !1 !== i.fancybox.defaults.hash && (i(t).on({
                ...
                "beforeShow.fb": function(i, s, n, o) {
                    var r;
                    n && !1 !== n.opts.hash && (r = a(s)) && (s.currentHash = r + (s.group.length > 1 ? "-" + (n.index + 1) : ""), e.location.hash !== "#" + s.currentHash && (o && !s.origHash && (s.origHash = e.location.hash), s.hashTimer && clearTimeout(s.hashTimer), s.hashTimer = setTimeout(function() {
        ...
        e.mask = {
            ...
            mask: function(i, o) {
                ...
                return o = e.extend({
                    ...
                    completed: null
                }, o), r = e.mask.definitions, l = [], d = u = i.length, c = null, i = String(i), e.each(i.split(""), function(e, t) {
                    "?" == t ? (u--, d = e) : r[t] ? (l.push(new RegExp(r[t])), null === c && (c = l.length - 1), e < d && (p = l.length - 1)) : l.push(null)
                    ...
                    function x(e, t) {
                        ...
                        if (!(e < 0)) {
                            for (i = e, s = w(t); i < u; i++)
                                if (l[i]) {
                                    if (!(s < u && l[i].test(m[s]))) break;
                                    m[i] = m[s], m[s] = y(s), s = w(s)
                                }
                    ...
                    function E(e) {
                        ...
                        for (t = 0, s = 0; t < u; t++)
                            ...
                            } else m[t] === n.charAt(s) && s++, t < d && (a = t);
                        return e ? T() : a + 1 < d ? o.autoclear || m.join("") === v ? (f.val() && f.val(""), C(0, u)) : T() : (T(), f.val(f.val().substring(0, a + 1))), d ? t : c
                    }
                    f.data(e.mask.dataName, function() {
                        ...
                        var e;
                        f.prop("readonly") || (clearTimeout(t), g = f.val(), e = E(), t = setTimeout(function() {
                            f.get(0) === document.activeElement && (T(), e == i.replace("?", "").length ? f.caret(0, e) : f.caret(e))
                        }, 10))
                    }).on("blur.mask", S).on("keydown.mask", function(e) {
                        if (!f.prop("readonly")) {
                            var t, i, n, a = e.which || e.keyCode;
                            h = f.val(), 8 === a || 46 === a || s && 127 === a ? (i = (t = f.caret()).begin, (n = t.end) - i == 0 && (i = 46 !== a ? function(e) {
                                for (; --e >= 0 && !l[e];);
                                return e
                            }(i) : n = w(i - 1), n = 46 === a ? w(n) : n), C(i, n), x(i, n - 1), e.preventDefault()) : 13 === a ? S.call(this, e) : 27 === a && (f.val(g), f.caret(0, E()), e.preventDefault())
                        }
                    }).on("keypress.mask", function(t) {
                        if (!f.prop("readonly")) {
                            var i, s, n, o = t.which || t.keyCode,
                                r = f.caret();
                            t.ctrlKey || t.altKey || t.metaKey || o < 32 || !o || 13 === o || (r.end - r.begin != 0 && (C(r.begin, r.end), x(r.begin, r.end - 1)), (i = w(r.begin - 1)) < u && (s = String.fromCharCode(o), l[i].test(s)) && (function(e) {
                                var t, i, s, n;
                                for (t = e, i = y(e); t < u; t++)
                                    if (l[t]) {
                                        if (s = w(t), n = m[t], m[t] = i, !(s < u && l[s].test(n))) break;
                                        i = n
                                    }
                            }(i), m[i] = s, T(), n = w(i), a ? setTimeout(function() {
                                e.proxy(e.fn.caret, f, n)()
                            }, 0) : f.caret(n), r.begin <= p && b()), t.preventDefault())
                        }
                    ...
                    }), n && a && f.off("input.mask").on("input.mask", function(e) {
                        var t = f.val(),
                            i = f.caret();
                        if (h && h.length && h.length > t.length) {
                            for (E(!0); i.begin > 0 && !l[i.begin - 1];) i.begin--;
                            if (0 === i.begin)
                                for (; i.begin < c && !l[i.begin];) i.begin++;
                            f.caret(i.begin, i.begin)
                        } else {
                            E(!0);
                            var s = t.charAt(i.begin);
                            i.begin < u && (l[i.begin] ? l[i.begin].test(s) && i.begin++ : (i.begin++, l[i.begin].test(s) && i.begin++)), f.caret(i.begin, i.begin)
                        }
                        b()
                    }), E()
                })
